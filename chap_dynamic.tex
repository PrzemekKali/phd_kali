...
\end{itemize}
Nomogram (rys. \ref{fig:ec_algorithm_dyna_boundary}) oraz tablice w załączniku F, powstały w celu ułatwienia uwzględnienia efektów dynamicznych dla użytkowników normy. Dzięki nim wykonana już praca badaczy pozwala na wykluczenie z obowiązku prowadzenia pełnej analizy dynamicznej prostych, powtarzalnych konstrukcji. Granice dolna i górna nomogramu są wynikiem odpowiednio kryterium dynamicznego oddziaływania 

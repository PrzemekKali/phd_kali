...
\begin{figure}[p]
	...
	\subfloat[Mod 1, $f_1=1.468\, \text{Hz}$]{\label{fig: wk2_research_mod01}%
			\begin{tabular}[b]{c c c}
				\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_11_time_20_08_21.pdf}%
				\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_11_time_13_58_03.pdf}%
				\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_11_time_13_59_19.pdf}%
		\end{tabular}}\\
	\subfloat[Mod 2, $f_2=2.481\,\text{Hz}$]{\label{fig: wk2_research_mod02}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_23_time_20_09_19.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_23_time_20_09_26.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_23_time_16_57_54.pdf}%
\end{tabular}}\\
	\subfloat[Mod 3, $f_3=2.551\, \text{Hz}$]{\label{fig: wk2_research_mod03}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_25_time_20_09_56.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_25_time_20_10_13.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_25_time_16_58_42.pdf}%
\end{tabular}}\\
	\subfloat[Mod 4, $f_4=2.769\, \text{Hz}$]{\label{fig: wk2_research_mod04}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_27_time_20_10_31.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_27_time_14_00_02.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_27_time_14_00_19.pdf}%
\end{tabular}}\\
...
\begin{figure}[p]\ContinuedFloat
	...
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_33_time_20_11_02.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_33_time_20_11_12.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_33_time_17_00_05.pdf}%
\end{tabular}}\\

	\subfloat[Mod 6, $f_6=4.853\, \text{Hz}$]{\label{fig: wk2_research_mod06}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_47_time_20_11_28.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_47_time_20_11_53.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_47_time_17_00_46.pdf}%
\end{tabular}}\\
	\subfloat[Mod 7, $f_7=5.809\, \text{Hz}$]{\label{fig: wk2_research_mod07}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_57_time_20_12_12.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_57_time_20_12_20.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_57_time_17_01_27.pdf}%
\end{tabular}}\\
	\subfloat[Mod 8, $f_8=5.874\, \text{Hz}$]{\label{fig: wk2_research_mod08}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_59_time_20_12_37.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_59_time_20_12_48.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_59_time_17_02_08.pdf}%
\end{tabular}}\\
	\end{tabular}
...
\begin{figure}[H]\ContinuedFloat
	...
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_61_time_20_13_07.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_61_time_20_13_32.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_61_time_17_17_06.pdf}%
\end{tabular}}\\
	\subfloat[Mod 10, $f_{10}=7.483\, \text{Hz}$]{\label{fig: wk2_research_mod10}%
	\begin{tabular}[b]{c c c}
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_75_time_20_13_51.pdf}%
		\includegraphics[height=0.18\textheight,trim=0 0 0 25,clip]{/wk2/ident/mods/fig_mod_75_time_14_01_31.pdf}%
		\includegraphics[height=0.18\textheight]{/wk2/ident/mods/fig_polar_mod_75_time_14_01_40.pdf}%
\end{tabular}}\\
...
\higr{Stworzony wstępny model numeryczny powstał z wykorzystaniem założeń projektowych przedstawionych w dokumentacji. Przy budowie modelu poczyniono szereg naturalnych uproszczeń, zwłaszcza w detalach konstrukcji takich jak wezgłowia czy połączenia pomiędzy elementami. Wykorzystanie takiego modelu do badań numerycznych może wiązać się ze znacznymi rozbieżnościami pomiędzy pracą konstrukcji rzeczywistej i modelu. Aby tego uniknąć przeprowadzono kalibrację modelu opierając się na rezultatach przeprowadzonych badań. Zidentyfikowane parametry dynamiczne i wyniki badań odbiorczych pod próbnym obciążeniem dostarczyły szereg istotnych informacji o obiekcie w jego rzeczywistej formie. Kalibracja opierać będzie się na następujących danych wyjściowych:}
\begin{itemize}
...
\begin{tabular}{@{}p{0.1\linewidth} p{0.05\linewidth} *8{P{0.10625\linewidth}}@{}}
	...
	\multirow{2}{*}{Zakres}  & min & 0.80 & 0.85  & 0.70         & 0.7   & 0.9  & 0.7      & 0.9     & 1.0       \\ \cmidrule(){2-10} 
...
Zgodnie z przyjętymi założeniami dotyczącymi znaczenia i dokładności wyznaczania funkcji celu, przede wszystkim znacznie zredukowano wartość funkcji celu związanej z częstotliwościami drgań własnych $f_{freq}$. Pozostałe funkcje celu pozostają na zadowalającym poziomie (por. Tab. \ref{tab:minimal_values_calibration}). Ostateczne rozwiązanie zostało przyjęte w dalszej części związanej z obliczeniami dynamicznymi konstrukcji. \higr{Podsumowując, wykonana kalibracja pozwala wyciągnąć następujące wnioski:}
\begin{itemize}
	\item optymalizacja rojem cząstek jest skutecznym i uniwersalnym narzędziem kalibracji modelu numerycznego,
	\item zastosowanie wielokryterialnego wariantu optymalizacji pozwala na ocenę dokładności punktów odniesienia dla kryteriów funkcji celu oraz przypisanie wag poszczególnym kryteriom nawet po wykonaniu niezbędnych analiz,
	\item moduł sprężystości materiału elementów strukturalnych dźwigara został obniżony o około 8\%, a elementów pomostu i ściągów zwiększony o około 10\%,
	\item zastosowany sposób modelowania wezgłowia za pomocą rusztu elementów belkowych o przekroju równym zaprojektowanym blachom okazał się zbyt podatny. W procesie kalibracji moduł sprężystości materiału elementów belkowych został zwiększony aż około 8 razy,
	\item możliwe jest poprawne zidentyfikowanie i dostosowanie sztywności warunków brzegowych za pomocą przedstawionej metody kalibracji. Aby zwiększyć pewność otrzymanego rezultatu tego aspektu kalibracji należy pamiętać, że wyniki pomiarów identyfikacyjnych muszą umożliwić ocenę podatności łożysk, na przykład przez pomiar przyspieszeń lub przemieszczeń na łożyskach,
	\item największą niepewnością w określeniu masy niekonstrukcyjnej na obiekcie cechuje się podsypka tłuczniowa. Mnożniki dla obu części tego obciążenia wynosiły odpowiednio 68\% oraz 76\%. Pomimo trudnej w inwentaryzacji geometrii podsypki na obiekcie, można zaryzykować stwierdzenie że przyjęty, normowy ciężar podsypki jest większy od rzeczywistego. Dobrane według projektu konstrukcji masy dodatkowych elementów łuku (przepon, zakotwień wieszaków) oraz pomostu serwisowego zostały zredukowane do ok 80\%. Masa dodatkowych elementów ściągu i stężeń została zmodyfikowana odpowiednio o kilka procent.
\end{itemize}
...
Analizę dynamiczną przeprowadzono dla wszystkich dziesięciu modeli obciążeń pociągami uniwersalnymi HSLM-A wg PN-EN 1991-2 (p. \ref{sect: eurokod_obciazenia_dyn}). Prędkości pociągów przyjmowano zgodnie z zaleceniem w zakresie od 40 km/h do założonej maksymalnej prędkości obliczeniowej. Jednakże odstępując od zaleceń nie przyjmowano stałego przyrostu prędkości. Wybrano jedynie prędkości, które mieszczą się w powyższym zakresie oraz są prędkościami krytycznymi wyznaczonymi dla pierwszych dwóch częstotliwości drgań własnych. Prędkości krytyczne obliczano na podstawie wzoru (\ref{eq:criticla_speed}). Założono, że odpowiedź obiektu osiąga swoją maksymalną wartość dla prędkości krytycznej i nawet przy zwiększeniu prędkości nie przekracza tej wartości \parencite{Goicolea2008}. Potrzebne dwie pierwsze częstotliwości drgań własnych odczytywano z modelu numerycznego po przeprowadzeniu analizy modalnej. Dla każdego rodzaju pociągu HSLM-A indywidualnie wyznaczano prędkość na bazie typowego dla pociągu HSLM-A rozstawu osi $d$, odczytanych częstotliwości drgań własnych $f_i$ oraz przyjmując wartość dzielnika z zakresu $n = 1,2\dots 10$. Wybierano taką wartość $n$, aby prędkość krytyczna związana z częstotliwością $f_i$ była jak najwyższa i mieściła się w dopuszczalnym zakresie prędkości. Dodatkowo w razie położenia prędkości rezonansowej tuż za maksymalną wartością prędkości, do analizy każdego pociągu dodano maksymalną dozwoloną prędkość pociągu na linii. Podsumowując, dla danego wariantu zmiennych projektowych analizę prowadzono dla 10 różnych pociągów HSLM-A, po 3 prędkości przejazdu (2 krytyczne i maksymalna). Sumarycznie daje to około 30 przejazdów dynamicznych na wariant, w których zawarty jest najbardziej niekorzystny wariant obciążenia. \higr{Dzięki temu założeniu uniknięto analizy dla wszystkich zalecanych prędkości od 40 km/h do prędkości maksymalnej z krokiem co 10 km/h. Aby udowodnić, że przyjęte uproszczenie pozwala uzyskać najbardziej niekorzystne rezultaty, przeprowadzono testową analizę dynamiczną. Dla każdego z trzech modeli różniących się geometrią i układem wieszaków wyznaczono maksymalne przyspieszenia od obciążenia modelami HSLM-A. Obliczenia wykonano w pełnym zalecanym w normie zakresie prędkości, z prędkością maksymalną równą 300 km/h. Do regularnego zbioru prędkości dodano również prędkości rezonansowe wyznaczone metodą opisaną powyżej. Rezultaty przedstawiono na rysunkach} \ref{fig:wk2_opti_proste_predkosci_test_all_proste}-\ref{fig:wk2_opti_proste_predkosci_test_all_network}. \higr{W każdej z analiz największe przyspieszenia uzyskano dla prędkości rezonansowych lub prędkości maksymalnych, które są nieznacznie mniejsze niż prędkości rezonansowe wykraczające poza zakres analizy. Na grafikach ujawniają się wyraźnie przekątne charakteryzujące się znacznie większymi przyspieszeniami niż dla sąsiednich prędkości. Pokrywają się one z prędkościami rezonansowymi. Diagonalny układ wzrostu przyspieszeń wynika z regularnego rozstawu grup osi w modelach HSLM-A. Wymiar charakterystyczny modeli HSLM-A oznaczony jako $D$ jest długością wagonu i zmienia się co 1 m. Powoduje to że dla danej częstotliwości drgań własnych prędkość rezonansowa nieznacznie, liniowo rośnie dla kolejnych modeli. Zarówno w analizach przedstawionych na rysunkach, jak i pozostałych nieudokumentowanych testach największe wartości przyspieszeń pomostu osiągano dla prędkości rezonansowych lub maksymalnych.}

\begin{figure}[hbt!]
	\centering
	\includegraphics[trim=0 0 0 3, clip]{WK2/opti/predkosci_wszystkie/proste_wyniki_mapa.pdf}
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[trim=0 0 0 3, clip]{WK2/opti/predkosci_wszystkie/nielsen_wyniki_mapa.pdf}
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[trim=0 0 0 3, clip]{WK2/opti/predkosci_wszystkie/network_wyniki_mapa.pdf}	
	\captionsetup{justification=centering}
...
\begin{enumerate}
	...
	\item Generacja obciążenia pociągiem HSLM-A. Analiza dynamiczna przejazdu pociągu po obiekcie. Odczytanie przebiegu przyspieszeń w czasie dla trzech punków zlokalizowanych na dźwigarze-ściągu w odległościach $1/4L$, $1/2L$ i $3/4L$ od podpory. Krok ten wykonywany jest dla wszystkich dziesięciu pociągów HSLM-A i wyznaczonych prędkości. Łącznie około 30 analiz dynamicznych.
...
\begin{figure}[hbt!]
	...
	\captionsetup{justification=centering}
	\caption{Przykładowe elementy wizualizacji rezultatów analizy optymalizacyjnej - część 1}
	\label{fig:EXAMPLE_picture_1_2}
\end{figure}

Druga grafika pokazuje wartości zmiennych projektowych w dziedzinie funkcji celu (na przykład rys. \ref{fig:EXAMPLE_picture_1_2_b}). Do sporządzenia grafiki użyto jedynie punkty, które spełniają warunki ograniczeń od góry - \textit{NOK-H}. W każdym wariancie (a-c) za pomocą mapy kolorów określono wartość innej zmiennej: (a) wysokości ściągu, (b) wysokości łuku i (c) średnicy wieszaka. Czarną przerywaną liniową ponownie zaznaczono przyspieszenie $3.5\,\mathrm{m/s^2}$. Wyświetlanie wyników ograniczono do punków w obszarze maksymalnych przyspieszeń do $10\,\mathrm{m/s^2}$ i masy konstrukcji do 200 t.
...
\begin{figure}[hbt!]
	...
	\captionsetup{justification=centering}
	\caption{Przykładowe elementy wizualizacji rezultatów analizy optymalizacyjnej - część 2}
	\label{fig:EXAMPLE_picture_3}
\end{figure}

Czwarty zestaw prezentuje zależność między wartością zmiennej projektowej rozwiązania, a uzyskanymi maksymalnymi wartościami przyspieszeń rozwiązań należących do Frontu Pareto (na przykład rys. \ref{fig:EXAMPLE_picture_4_5_a}). Dla prezentowanych zależności wyznaczono wartości funkcji korelacji zerowej \teng{correlation}, korelacji cząstkowej \teng{partial correlation} i korelacji semicząstkowej (częściowej) \teng{semipartial correlation} \parencite{Tabachnick}. Wyniki korelacji zestawiono w tabelach (na przykład tab. \ref{tab: correlation_proste_160}). Do wyznaczania współczynników użyto metody Pearsona. Oceniając wyznaczone miary jakości dopasowania należy zdawać sobie sprawę ze spełnienia jedynie części założeń wymaganych przy obliczaniu korelacji Pearsona
\footnote{
...
\begin{figure}[hbt!]
	...
	\captionsetup{justification=centering}
	\caption{Przykładowe elementy wizualizacji rezultatów analizy optymalizacyjnej - część 3}
...
\begin{figure}[hbt!]
	...
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu w zależności od zmiennych projektowych: wieszaki proste, prędkość maksymalna 300 km/h}
...
\begin{table}[hbt!]
	...
	\begin{tabular}{@{}p{0.155\linewidth} P{0.155\linewidth} P{0.23\linewidth} P{0.155\linewidth} P{0.155\linewidth} P{0.155\linewidth} @{}}	
		%\begin{tabular}{@{}ccccccc@{}}
			...
			Proste  & 300     & 132.0       & 27.15 & 104.04 & 0.81             \\
...
Wynika stąd, że wariant z wieszakami prostymi po zmianie na wieszaki Network nie powinien spełnić warunków poprawności rozwiązania. W przeciwnym razie ujawniłby się jako rozwiązanie lepsze (lżejsze) od wyznaczonych rozwiązań optymalnych dla wariantu Network. Dokonano eksperymentu i sprawdzono maksymalne przyspieszania dla \enquote{najlepszego} rozwiązania z wieszakami prostymi, zamieniając jedynie układ wieszaków na wariant Network. Maksymalne przyspieszenia pomostu wyniosły w tym przypadku ponad 4.00 $\text{m}/\text{s}^2$.

Poszukiwania przyczyn zaistniałego dysonansu przeniesiono do dziedziny częstotliwości drgań własnych układu. Dla \enquote{najlepszego} optymalnego zestawu wymiarów elementów konstrukcyjnych wariantu z wieszakami prostymi i przy prędkości maksymalnej 300 km/h (Tab. \ref{tab:summary_optimal_results}) przeprowadzono eksperyment polegający na zamianie wieszaków na system Network i uzmiennieniu sztywności wieszaków (Rys. \ref{fig:proste_na_network_wiz}).
...
Sztywność ta ograniczona jest jedynie do sztywności podłużnej zdefiniowanej iloczynem modułu sprężystości i pola przekroju wieszaków ($EA$). Nie chcąc uwzględniać wpływu zmiany masy w prowadzonej analizie przyjęto stałą średnicę wieszaków jak w \enquote{najlepszym} rozwiązaniu dla wieszaków prostych ($d=46\;\mathrm{mm}$). Jako zmienną przyjęto moduł sprężystości materiału. Dla każdego przypadku sztywności wieszaków wyznaczono przyspieszenia maksymalne zgodnie z algorytmem opisanym w punkcie \ref{sect:optimization_assumptions}. Obliczono również sześć pierwszych częstotliwości drgań własnych układu. Wyniki zaprezentowano w zależności od ekwiwalentnej średnicy. Ekwiwalentna średnica określa pole przekroju kołowego tak, aby wartość sztywności $EA$ dla zmiennego modułu sprężystości odpowiadała modułowi sprężystości stali $E=210\; \mathrm{GPa}$. Rezultaty przedstawiono na rysunku \ref{fig:proste_na_network_change_hangers_stiff}. Zaprezentowane wyniki wskazują, że dla rozwiązania z dominującym dźwigarem/ściągiem i o wiotkim łuku zmiana wieszaków z układu prostego na Network nie obniża maksymalnych przyspieszeń i dla żadnej średnicy ekwiwalentnej nie znaleziono rozwiązania dopuszczalnego. Najmniejsze wartości uzyskano dla zakresu średnicy ekwiwalentnej od 8 do 16 mm. Zauważyć można również, że po przekroczeniu tych wartości, w rozwiązaniu z dominującym ściągiem, im sztywniejsze jest połączenie pomiędzy łukiem, a ściągiem tym większe są maksymalne przyspieszenia. Przebieg zmienności maksymalnych przyspieszeń ma charakter raczej gładki, bez nagłych wzrostów przyspieszeń.

\begin{figure}[hbt!]
	\centering
	\includegraphics[width=\linewidth,trim=5 5 5 5 ,clip]{WK2/dyskusja/proste_netw_change_stiff.pdf}
	\captionsetup{justification=centering}
...
Potwierdzono, że układ wieszaków ma istotne znaczenie na maksymalne przyspieszenia pomostu i co ważniejsze niekoniecznie relacja jest ta zgodna ze zdroworozsądkową sztywnością globalną układu. Analogiczną analizę przeprowadzono dla dwóch dodatkowych modeli o skrajnie różnych rozkładach wieszaków: \enquote{najlepszych} rozwiązań uzyskanych przy prędkości do 300 km/h i wieszaków prostych (Rys. \ref{fig:proste_najlepsze_wiz}) oraz Network (Rys. \ref{fig:network_najlepsze_wiz}). Wyniki przedstawiono na rysunkach odpowiednio \ref{fig:proste_change_hangers_stiff} i \ref{fig:network_change_hangers_stiff}. 

\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.7\linewidth]{WK2/dyskusja/plaski_ogolny_proste_najlepsze_proste.jpg}
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.7\linewidth]{WK2/dyskusja/plaski_ogolny_network_najlepszy_network.jpg}
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=\linewidth,trim=5 5 5 5 ,clip]{WK2/dyskusja/proste_change_stiff_hangers.pdf}
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=\linewidth,trim=5 5 5 5 ,clip]{WK2/dyskusja/network_change_stiff_hangers.pdf}
	\captionsetup{justification=centering}
...
W \enquote{najlepszym} rozwiązaniu z wieszakami prostymi widoczny jest wyraźny przyrost maksymalnych przyspieszeń dla średnicy ekwiwalentnej w zakresie od 8 do 32 mm. Jednakże przedstawiony rezultat w zakresie bardzo małych średnic ekwiwalentny należy traktować ostrożnie. Dla bardzo małych średnic wieszaków sztywność połączenia ściągu i łuku jest niewielka. Wpływa to na postaci drgań własnych w ten sposób, że jedna z pierwszych postaci drgań własnych struktury dotyczy wyłącznie łuku (Rys. \ref{fig:small_stiff_hangers_mode_shape}). Częstotliwości drgań własnych w stosowanym algorytmie wpływają na proponowane prędkości krytyczne. Jeżeli wśród pierwszych dwóch postaci znajduje się przynajmniej jedna niezwiązana z drganiami pomostu to proponowana prędkość krytyczna nie wywoła w pomoście dużych drgań. Widoczne niskie wartości maksymalnych przyspieszeń dla średnicy ekwiwalentnej poniżej 8 mm są efektem właśnie tego zjawiska. Potraktowano je jako nieprawdziwe i wykluczono z wnioskowania. Od średnicy ok 8 mm dwie pierwsze postaci drgań dotyczą całej struktury dźwigara. Podobny problem nie występuje w przypadku wieszaków Network, ponieważ ten układ wieszaków zapewnia współpracę pomiędzy łukiem i ściągiem w całym rozpatrywanym zakresie średnic.

\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.7\linewidth]{WK2/dyskusja/plaski_ogolny_tylko_luk.jpg}
	\captionsetup{justification=centering}
...
Oba przeanalizowane przypadki pokazują, że istnieje wyraźna wartość graniczna średnicy ekwiwalentnej wieszaków po której przekroczeniu najniższe częstotliwości drgań własnych stabilizują się. Rozpatrując podane przykładowe przypadki, można zauważyć że stabilizacja dwóch najniższych częstotliwości drgań wydaje się mieć związek ze stabilizacją maksymalnych przyspieszeń pomostu. Dla wariantu z wieszakami prostymi, krzywa maksymalnych przyspieszeń staje się niemal płaska od średnicy równej około 46 mm, a dla układu Network od około 70 mm. Układ Network wymaga wprowadzenia większych średnic wieszaków do układu, ponieważ łuk odgrywa znacznie większą rolę w przenoszeniu obciążeń i jest znacznie sztywniejszy niż w przypadku niskiego przekroju łuku w wariancie z wieszakami prostymi. Rozpatrywane przypadki zmiany sztywności układu i przez to częstotliwości drgań własnych są przypadkiem szczególnym i nie pozwalają na wyciągnięcie bardziej ogólnych wniosków. W kolejnym kroku zdecydowano o przeanalizowaniu całych zestawów rozwiązań pochodzących z optymalizacji w przestrzeni częstotliwości i postaci drgań własnych.



\newpage
\subsection{Rezultaty w dziedzinie pierwszych dwóch modów}

%\subsubsection{Podział ze względu na postaci drgań własnych}

W niniejszej części pracy wartości funkcji celu oraz zmiennych projektowych z przeprowadzonych optymalizacji przedstawiono w zależności od pierwszych dwóch częstotliwości drgań własnych. Jednak tym razem rozróżniono mody również ze względu na postaci drgań własnych. Rozpatrywano dwie pierwsze postaci drgań własnych, z których jedna zawsze charakteryzuje się rozkładem przemieszczeń w formie zbliżonej do jednej półfali sinusa, a druga do dwóch półfal sinusa. Identyfikację, który mod ma daną postać odbyła się przez zastosowanie kryterium MAC w zestawianiu z wzorcami o klarownych postaciach z jedną lub dwiema półfalami. Rezultaty porównania przedstawiono na rysunku \ref{fig:minimum_mac_values_shape_division}. Czarna linia reprezentuje funkcję liniową $y=x$ czyli równość częstotliwości dla obu postaci. Linia ta również wskazuje, który mod charakteryzuje się wyższą częstotliwością. Dla rozwiązań leżących powyżej czarnej linii postać o dwóch półfalach jest pierwszym modem, a dla rozwiązań poniżej linii pierwszym modem jest postać o jednej półfali.

\begin{figure}[H]
	\centering
	\subfloat[wieszaki proste]{\includegraphics[width=0.5\textwidth,trim=40 20 5 25, clip]{WK2/opti/proste_160/proste_160_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[wieszaki ukośne]{\includegraphics[width=0.5\textwidth,trim=40 20 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_MIN_MAC_XY.pdf}} \\
	\subfloat[wieszaki Network]{\includegraphics[width=0.5\textwidth,trim=40 20 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_MIN_MAC_XY.pdf}}
	
	\caption{Podział rozwiązań optymalizacji ze względu na dwie pierwsze postaci drgań własnych, z zaznaczeniem minimalnej wartości kryterium MAC}
	\label{fig:minimum_mac_values_shape_division}
\end{figure}

Poprawność identyfikacji postaci drgań dla dwóch pierwszych częstotliwości drgań własnych uzyskanych rezultatów jest podstawą do dalszych analiz i poprawności wnioskowania. Na podstawie rezultatów pokazanych na rysunku \ref{fig:minimum_mac_values_shape_division} stwierdzono, że podział na postaci drgań w zdecydowanej większości został wykonany poprawnie. Kryterium MAC pomiędzy postaciami, a wzorcami jest dla większości rozwiązań większe niż 0.85. Jedynie rozwiązania w pobliżu przekątnej wyznaczającej równe częstotliwości dla obu postaci charakteryzują się kiepskim dopasowaniem do wzorca. Związane jest to ze zmianą kolejności pomiędzy modem z pojedynczą półfalą i dwiema półfalami. W obszarze bliskich sobie częstotliwości, postaci zbliżają się do siebie w swojej formie i odbiegają od wzorców. Położenie w dziedzinie częstotliwości i postaci drgań własnych tych rozwiązań jest w sposób mocno niepewne, ponieważ kryterium MAC jest mniejsze niż 0.8. Niemniej ze względu na to, że są one zlokalizowane w pobliżu przekątnej $y=x$ to ich położenie w przestrzeni przy błędnie przypisanych postaciach nie zmieniłoby się istotnie. 
...
Wyniki opracowano dla wszystkich przypadków optymalizacji i wszystkich rozwiązań spełniających ograniczenia. W prezentacji graficznej uwzględniono następujące wyniki:
\begin{itemize}
	\item (a) masę konstrukcji,
	\item (b) maksymalne przyspieszenia pomostu,
	\item (c) wysokość ściągu,
	\item (d) wysokość łuku,
	\item (e) liczbę półfal postaci drgań własnych modu, dla którego wyznaczona prędkość krytyczna wywołała największe przyspieszenia pomostu. Dla danego rozwiązania ze wszystkich przejazdów obciążenia wybrano ten charakteryzujący się wywołaniem największych przyspieszeń. Dla powiązanej z daną prędkością przejazdu częstotliwości określono postać drgań i opisano ją za pomocą liczby półfal. Dla przypadków gdzie decydowała prędkość maksymalna, a nie prędkość krytyczna wyznaczona na podstawie częstotliwości drgań własnych przyjęto w rezultacie 0.
\end{itemize}

Nie pokazano wyników dla zmiennej średnicy wieszaków ponieważ - jak już wcześniej zauważono - powyżej pewnej wartości progowej wielkość ta nieznacznie wpływa na przyspieszenia pomostu. Zielonym, prostokątnym obrysem zaznaczono obszar zawierający wszystkie rozwiązania z przyspieszeniami maksymalnymi pomostu mniejszymi niż $3.5\;\mathrm{m/s^2}$. Czerwony trójkąt oznacza \enquote{najlepsze} rozwiązanie - minimalna masa konstrukcji i jednocześnie przyspieszenia spełniające warunek $3.5\;\mathrm{m/s^2}$ (Tablica \ref{tab:summary_optimal_results}).

Na rysunkach przedstawiających decydującą postać drgań (e) zaznaczono czarnymi liniami przerywanymi pewne, charakterystyczne częstotliwości. Obliczono je przyrównując prędkość maksymalną przejazdu do prędkości rezonansowej modelu obciążenia HSLM-A1 o najmniejszym charakterystycznym rozstawie osi wózków $d=18\,\mathrm{m}$ i dzielniku $k=1$ według wzoru (\ref{eq:critical_speed_2}).
...
\begin{figure}[h]
	...
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_DEC_FREC_XY.pdf}} \hfill
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_VELOCITY_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 160 km/h}
...
\begin{figure}[h]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_VCR_DIV_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 160 km/h. Kont.}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VELOCITY_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 200 km/h}
	
\end{figure}

\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VCR_DIV_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 200 km/h. Kont.}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_VELOCITY_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 300 km/h}
	
\end{figure}

\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_VCR_DIV_XY.pdf}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych z rozróżnieniem postaci drgań - wariant z wieszakami prostymi - prędkość maksymalna 300 km/h. Kont.}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_DEC_FREC_XY.pdf}}
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_VCR_DIV_XY.pdf}}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_VCR_DIV_XY.pdf}}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_DEC_FREC_XY.pdf}}
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_VCR_DIV_XY.pdf}}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_VCR_DIV_XY.pdf}}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_VCR_DIV_XY.pdf}}
...
\begin{figure}[h]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_WEI_XY.pdf}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_ACC_XY.pdf}}\\
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_XY.pdf}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_XY.pdf}}\\
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_DEC_FREC_XY.pdf}}
	%\subfloat[minimalny wskaźnik MAC dopasowania postaci do wzorca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_VELOCITY_XY.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_HSLM_DEC_XY.pdf}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_VCR_DIV_XY.pdf}}
...
\clearpage
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków:
\begin{enumerate}
	\item Innymi słowy dla częstotliwości większych niż zaznaczone, wyznaczone prędkości krytyczne dla modeli obciążenia HSLM-A i dzielnika $k=1$ będą większe niż prędkość maksymalna i muszą być zredukowane dzielnikiem $k>1$. W konsekwencji wymuszenie będzie zgodne z co $k$-tą postacią drgań własnych.
	\item Dla wariantu z wieszakami prostymi występują wyraźne korelacje pomiędzy:
	\begin{itemize}
		\item częstotliwością drgań własnych o postaci z podwójną półfalą, a wysokością ściągu,
		\item częstotliwością drgań własnych o postaci z pojedynczą półfalą, a wysokością łuku.
	\end{itemize}
	\item Dla wariantu z wieszakami prostymi istnieje wyraźny układ pionowych pasm, wyznaczonych przez częstotliwości graniczne drgań własnych z podwójną półfalą. Analizując położenie granic pasm zauważono, że minimalna częstotliwość drgań własnych o podwójnej półfali, dla której spełniony jest warunek przyspieszeń maksymalnych $3.5\;\mathrm{m/s^2}$ ma ściśle określone położenie. Odczytano wartość częstotliwości dla lewej krawędzi zielonego prostokąta granicznego dla wszystkich przypadków prędkości: 160 km/h - 2.387 Hz, 200 km/h - 2.979 Hz, 300 km/h - 4.457 km/h. Obliczono prędkości krytyczne dla rozstawu sił w modelu obciążenia HSLM-A równego minimalnej wartości 18 m i odczytanych częstotliwości. Otrzymano następujące minimalne prędkości krytyczne dla modeli pociągów HSLM-A:
	\begin{itemize}
		\item $c_{kr,160} = 2.387\;\mathrm{Hz} \cdot 18\;\mathrm{m} = 42.97\; \mathrm{m/s^2} = 154.7\; \mathrm{km/h} $
		\item $c_{kr,200} = 2.979\;\mathrm{Hz} \cdot 18\;\mathrm{m} = 53.62\; \mathrm{m/s^2} = 193.0\; \mathrm{km/h} $
		\item $c_{kr,300} = 4.457\;\mathrm{Hz} \cdot 18\;\mathrm{m} = 80.23\; \mathrm{m/s^2} = 288.8\; \mathrm{km/h} $
	\end{itemize}
	Powyższe wartości są w każdym przypadku nieznacznie niższe niż maksymalne rozważane prędkościom w danej analizie. Związek ten istnieje w przypadku wieszaków prostych tylko dla częstotliwości drgań własnych postaci o dwóch półfalach.
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_160/proste_160_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 160 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_160/proste_160_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 160 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_160/proste_160_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_160/proste_160_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 160 - wieszaki}
%\end{figure}
%
%
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 200 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 200 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_200/proste_200_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_200/proste_200_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 200 - wieszaki}
%\end{figure}
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 300 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/proste_300/proste_300_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 300 - wieszaki}
%\end{figure}
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 160 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 160 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_160/niels_160_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_160/niels_160_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 160 - wieszaki}
%\end{figure}
%
%
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 200 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 200 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_200/niels_200_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_200/niels_200_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 200 - wieszaki}
%\end{figure}
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 300 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 300 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/niels_300/niels_300_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki niels 300 - wieszaki}
%\end{figure}
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 160 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 160 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_160/netw_160_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_160/netw_160_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 160 - wieszaki}
%\end{figure}
%
%
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 200 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 200 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_200/netw_200_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_200/netw_200_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 200 - wieszaki}
%\end{figure}
...
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 300 - sciag}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 300 - łuk}
%\end{figure}
%\begin{figure}[hbt!]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=5   3 5  5, clip]{WK2/opti/netw_300/netw_300_FREQ_WIESZAK_ISO.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_WIESZAK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_WIESZAK_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_WIESZAK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki netw 300 - wieszaki}
%\end{figure}

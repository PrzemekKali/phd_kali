...
\begin{figure}[h]
	...
	\includegraphics[]{/dynamic_railway/hslm_b.pdf}
		\captionsetup{justification=centering}
	\caption{Model pociagu HSLM-B według PN-EN 1991-2. Na podstawie \parencite{PKNj}}
...
Norma PN-EN 1991-2 zwraca szczególną uwagę na sprawdzenie bezpieczeństwa nawierzchni kolejowej. Należy ocenić następujące wielkości:
\begin{itemize}
	\item przyspieszenia pionowe pomostu,
	\item skręcenie pomostu,
	\item przemieszczenia pionowe pomostu,
...
\captionsetup{justification=centering}
\caption{PRZERYSOWAĆ NA SZYBKOŚCI}

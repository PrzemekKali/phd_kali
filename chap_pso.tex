...
\end{equation}
Aby uzależnić przemieszczenie węzła $A$ od zmiennych projektowych posłużono się zasadą prac wirtualnych. Wyznaczono rozkład sił wewnętrznych od obciążenia zewnętrznego i obciążenia wirtualnego w miejscu badania przemieszczeń (Rys. \ref{}). Następnie wyznaczono wartość przemieszczeń zgodnie z wzorem \ref{}.

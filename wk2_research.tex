...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[]{/WK2/rysunki/przekroj_elementu_luk.pdf} }
	\subfloat[]{\includegraphics[]{/WK2/rysunki/przekroj_elementu_sciag.pdf} }
...
W procesie poczyniono szereg założeń związanych z wytrzymałością materiałów, uwarunkowaniami normowymi i ogólnymi warunkami wykonalności. Na rysunku pokazano przekroje poprzeczne elementów konstrukcji przęsła z zaznaczonymi zmiennymi projektowymi. Zakresy możliwych wartości zmiennych przedstawiono w tabeli.

...
\begin{enumerate}
	...
	\end{itemize}
	\item Maksymalne przyspieszenia charakteryzują się skokowymi zmianami związanymi z wielkością częstotliwości drgań własnych o podwójnej półfali (rys. \ref{fig:opti_res_2_freqs_prost_160_b}). Granice te pokrywają się z częstotliwościami $f_{160,1}^{max\,A10}$ i $f_{160,1}^{max\,A1}$ postaci z podwójną półfalą. 
	...
	\item W większości przeanalizowanych przypadków decydująca o maksymalnych przyspieszeniach jest prędkość krytyczna związana z częstotliwością o postaci z podwójną półfalą (rys. \ref{fig:opti_res_2_freqs_prost_160_e}). Dopiero po przekroczeniu częstotliwości ok. 4.2 Hz dla tej postaci, najgorsze przyspieszenia uzyskuje się dla częstotliwości drgań o postaci z pojedynczą półfalą.
...
\begin{figure}[H]
	...
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_f}}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_h}}
...
\begin{enumerate}
	\item Maksymalne przyspieszenia charakteryzują się skokowymi zmianami dla częstotliwości drgań własnych o podwójnej półfali (rys. \ref{fig:opti_res_2_freqs_prost_200_b}). Granice te pokrywają się z częstotliwościami $f_{200,1}^{max\,A10}$ i $f_{200,1}^{max\,A1}$ postaci z podwójną półfalą. 
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami pionowymi i prędkością maksymalną 300 km/h. W większości pokrywają się one z wynikami analiz o prędkościach maksymalnych 160 i 200 km/h:
\begin{enumerate}
	\item Maksymalne przyspieszenia charakteryzują się skokowymi zmianami dla częstotliwości drgań własnych o podwójnej półfali (rys. \ref{fig:opti_res_2_freqs_prost_300_b}). Granice te pokrywają się z częstotliwościami $f_{300,1}^{max\,A10}$ i $f_{300,1}^{max\,A1}$ postaci z podwójną półfalą. 

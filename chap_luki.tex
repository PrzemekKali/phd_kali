...
\begin{itemize}
	...
	\item pomost usytuowany w całości poniżej łuku - z jazdą dołem (Rys. \ref{fig:bri_deck_loc_middle}, \ref{fig:arch_deck_bridges_b}),
	\item pomost usytuowany pośrednio - z jazdą pośrednią (Rys. \ref{fig:bri_deck_loc_bott}, \ref{fig:arch_deck_bridges_c}).
\end{itemize}
...
\begin{itemize}
	\item pełnościenny przekrój łuku (dźwigar stalowy) (Rys. \ref{fig:arch_deck_bridges_c}),
	\item łuk w postaci kratownicy (dźwigar stalowy) (Rys. \ref{fig:arch_deck_bridges_b}),

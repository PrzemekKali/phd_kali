...
Dla kazdego wariantu optymalizacji oceniono wyniki i wyciągnięto następujące wynioski dotyczące rozwiązania:
\begin{itemize}
	\item możliwość wykorzystania układu w danym wariancie wieszaków i prędkości maksymalnej, przy spełnieniu kryterium bezpieczeństwa $3.5\,\mathrm{m/s^2}$,
	\item 
\end{itemize} 

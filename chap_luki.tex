...
\begin{figure}[h]
	\centering
	\subfloat[wieszki proste]{\includegraphics[width=0.7\linewidth,page=1]{/mosty_wstep/mosty.pdf} \label{fig:bridges_types_hangers_a}}  \\
...
Niepewności dotyczące parametrów modelu są naturalne i nieodzowne. Podstawowym zadaniem twórcy jest po jak najwierniejsze rzeczywistości przyjęcie ich wartości co jest niezwykle trudne i wymaga dużej wiedzy oraz doświadczenia. Jedną z metod na poprawę wartości parametrów jest ich bezpośrednia identyfikacja poprzez przykładowo badania laboratoryjne wbudowanego w konstrukcję materiału czy badania podłoża gruntowego. Druga metoda polega na jak najlepszym dopasowaniu wybranych wartości odpowiedzi modelu do odpowiadających wartości odpowiedzi konstrukcji rzeczywistej. Zestaw procesów prowadzących do tego dopasowania nazywa się kalibracją modelu numerycznego. 
...
Obiekt kolejowy uznaje się za poprawnie zaprojektowany jeśli spełnione są wszystkie Stany Graniczne Nośności i Użytkowania według PN-EN 1990 i PN-EN 1991-2, a w tym:  warunki nośności konstrukcji, trwałości zmęczeniowej, bezpieczeństwa nawierzchni kolejowej i wymagana klasa komfortu.

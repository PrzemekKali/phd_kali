...
Mając pewność co do poprawności podziału na postaci drgań, na kolejnych rysunkach przedstawiono wartości funkcji celu oraz zmiennych projektowych z przeprowadzonych optymalizacji, w zależności od pierwszych dwóch częstotliwości drgań własnych.
Wyniki stworzono dla wszystkich przypadków optymalizacji. W prezentacji graficznej uwzględniono następujące wyniki:
\begin{itemize}
...
\begin{figure}[p]
	...
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_160/proste_160_FREQ_DEC_FREC_XY.pdf}}

...
\begin{figure}[b]
	\centering
	\subfloat[Węzeł 7, kierunek Y]{\includegraphics[width=0.5\textwidth]{/test_blue/input_load/input_load_1.pdf}}%
	\subfloat[Węzeł 7, kierunek Z]{\includegraphics[width=0.5\textwidth]{/test_blue/input_load/input_load_2.pdf}}\\

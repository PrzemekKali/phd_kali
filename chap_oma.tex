...
\begin{figure}[H]
	...
	\subfloat[Mod 1, $f_1=19.70\;\text{Hz}$]{\label{fig: test_blue_sof_mod1}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip ]{/test_blue/sof_wis/image_small001.png}}%
	\subfloat[Mod 2, $f_2=54.93\; \text{Hz}$]{\label{fig: test_blue_sof_mod2}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small003.png}}%	
	\subfloat[Mod 3, $f_3=78.20\; \text{Hz}$]{\label{fig: test_blue_sof_mod3}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 3cm}, clip]{/test_blue/sof_wis/image_small004.png}}\\		
	\subfloat[Mod 4, $f_4=161.35\; \text{Hz}$]{\label{fig: test_blue_sof_mod4}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small005.png}}%
	\subfloat[Mod 5, $f_5=200.38\; \text{Hz}$]{\label{fig: test_blue_sof_mod5}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small006.png}}%
	\subfloat[Mod 6, $f_6=212.24\; \text{Hz}$]{\label{fig: test_blue_sof_mod6}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 0cm 2cm}, clip]{/test_blue/sof_wis/image_small007.png}}\\
	\subfloat[Mod 7, $f_7=217.12\; \text{Hz}$]{\label{fig: test_blue_sof_mod7}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small008.png}}%
	\subfloat[Mod 8, $f_8=336.59\; \text{Hz}$]{\label{fig: test_blue_sof_mod8}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 8cm}, clip]{/test_blue/sof_wis/image_small009.png}}%
	\subfloat[Mod 9, $f_9=410.22\; \text{Hz}$]{\label{fig: test_blue_sof_mod9}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small010.png}}\\
	\subfloat[Mod 10, $f_{10}=451.89\; \text{Hz}$]{\label{fig: test_blue_sof_mod10}%
		\includegraphics[width=0.33\linewidth, trim={2cm 2cm 1cm 10cm}, clip]{/test_blue/sof_wis/image_small011.png}}\\
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.88\linewidth,trim=0 8 0 17,clip]{/test_blue/fig_00_12_14_0.978.pdf}
	\captionsetup{justification=centering}

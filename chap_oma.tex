...
\begin{table}[hbt!]
	...
	%\resizebox{\textwidth}{!}{%
		...
		%\rowcolors{1}{}{gray!10}
		%\resizebox{\textwidth}{!}{%
		%\begin{tabular}{@{}  *9P{0.1\linewidth} P{0.1\linewidth} @{}}
		\begin{tabular}{@{}cccccccccc@{}}
			\toprule
			Mod     & {\textbf{\begin{tabular}[c]{@{}c@{}}Analiza\\ modalna\end{tabular}}} & {\textbf{\begin{tabular}[c]{@{}c@{}}Zakładane\\ tłumienie\end{tabular}}} & \multicolumn{4}{c|}{Model MES}         & \multicolumn{3}{c}{Badania*}                                        \\ \midrule
			Nr      & Częst. & LDT & Częst.   & Stosunek & LDT    & Stosunek & Częst.   & Stosunek & LDT \\ %   & \textbf{Stosunek**} \\ \midrule
			{[}-{]} & {[}Hz{]}   & {[}-{]}  & {[}Hz{]} & {[}\%{]} & {[}-{]} & {[}\%{]} & {[}Hz{]} & {[}\%{]} & {[}-{]} \\ % & \textbf{{[}\%{]}} \\ \midrule
			Mod 1   & {19.77}                                                              & {0.0303}                                                                 & 19.701            & 100\%             & 0.0291           & {96\%}              & 20.467            & 104\%             & 0.117      \\ %      & 388\%             \\ \midrule

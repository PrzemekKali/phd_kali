...
W dalszej części wartości funkcji celu oraz zmiennych projektowych z przeprowadzonych optymalizacji przedstawiono w zależności od pierwszych dwóch częstotliwości drgań własnych. Tym razem rozróżniono częstotliwości również pod względem postaci drgań własnych. Rozpatrywano dwie pierwsze postaci drgań własnych, z których jedna zawsze charakteryzuje się rozkładem przemieszczeń w formie jednej półfali sinusa, a druga w postaci dwóch półfal sinusa. Wyniki stworzono dla wszystkich przypadków optymalizacji, ale przedstawiono jedynie te dotyczące maksymalnej prędkości równej 300 km/h. W zależności od pierwszych dwóch częstotliwości i postaci drgań własnych przedstawiono całkowitą masę konstrukcji (połowa) oraz maksymalne przyspieszenia pomostu. Zmienne projektowe (wysokość ściągu i wysokość łuku) przedstawiono w rzutach na płaszczyzny układu współrzędnych o osiach oznaczających częstotliwości pierwszej i drugiej postaci drgań własnych oraz maksymalne przyspieszenia. Nie pokazano wyników dla zmiennej średnicy wieszaków ponieważ już wcześniej pokazano, że powyżej pewnej wartości progowej wielkość ta nieznacznie wpływa na ostateczny rezultat.
...
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_YZ.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_XZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XZ.pdf}}
	\captionsetup{justification=centering}
...
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_YZ.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_XZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_XZ.pdf}}
	\captionsetup{justification=centering}
...
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_YZ.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_XZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\textwidth,trim=40 26 5 26, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_XZ.pdf}}
	\captionsetup{justification=centering}
...
%\begin{figure}[p]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_WEI_XY.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_ACC_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_XY.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XY.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_YZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_YZ.pdf}}\\
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_XZ.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 26 5 26, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XZ.pdf}}
%	\captionsetup{justification=centering}
%	\caption{Wieszaki proste 300}
%	
%\end{figure}
%
%\begin{figure}[p]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_WEI_XY.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_ACC_XY.pdf}}\\
...
%\begin{figure}[p]
%	\centering
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_WEI_XY.pdf}}
%	\subfloat{\includegraphics[width=0.5\linewidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_ACC_XY.pdf}}\\

...
\begin{figure}[hbt!]
	\centering
	\captionsetup{justification=centering}
	\subfloat[Maksymalna wartość MAC wśród elementów poza przekątną macierzy]{\includegraphics[]{/WK2/automac/max_mac.pdf}}% 
	\subfloat[RMS wszystkich elementów poza przekątną macierzy]{\includegraphics[]{/WK2/automac/rms.pdf}} 
	\captionsetup{justification=centering}
...
\begin{tabular}{@{}p{0.1\linewidth} p{0.05\linewidth} *8{P{0.10625\linewidth}}@{}}
	...
	\multirow{2}{*}{\textbf{Zakres}}  & min & 0.80 & 0.85  & 0.70         & 0.7   & 0.9  & 0.7      & 0.9     & 1.0       \\ \cmidrule(){2-10} 
...
\begin{table}[hbt!]
	...
	\begin{tabular}{@{}p{0.1\linewidth} p{0.05\linewidth} *8{P{0.10625\linewidth}}@{}}
		...
		\multirow{2}{*}{\textbf{Zakres}}  & min & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ & $1\mathrm{E}{-9}$ \\ \cmidrule(){2-10} 
...
\begin{tabular}{@{}p{0.1\linewidth} p{0.05\linewidth} *6{P{0.1417\linewidth}}@{}}
	...
	\multirow{2}{*}{\textbf{Zakres}}  & min & 0.6 & 0.6   & 0.5       & 0.3       & 0.3    & 0.5      \\ \cmidrule(){2-8} 
...
\begin{figure}[p]
	\centering
	%width=0.48\linewidth
	\subfloat[S1 - Łuk]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_1.pdf}  \label{fig: hist_cal_1}}
	\subfloat[S2 - Ściąg]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_2.pdf}  \label{fig: hist_cal_2}}
	\subfloat[S3 - Poprz.]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_3.pdf}  \label{fig: hist_cal_3}}
	\subfloat[S4 - Żebra]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_4.pdf}  \label{fig: hist_cal_4}} \\
	\subfloat[S5 - Płyta]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_5.pdf}  \label{fig: hist_cal_5}}
	\subfloat[S6 - Stężenia]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_6.pdf}  \label{fig: hist_cal_6}}
	\subfloat[S7 - Wieszak]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_7.pdf}  \label{fig: hist_cal_7}}
	\subfloat[S8 - Wezgłowie]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_8.pdf}  \label{fig: hist_cal_8}} \\ 
	\subfloat[S21 - 2AX]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_9.pdf}  \label{fig: hist_cal_9}}
	\subfloat[S22 - 1AY]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_10.pdf}  \label{fig: hist_cal_10}}
	\subfloat[S23 - 1BX]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_11.pdf}  \label{fig: hist_cal_11}}
	\subfloat[S24 - 2BX]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_12.pdf}  \label{fig: hist_cal_12}} \\
	\subfloat[S25 - 1AX]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_13.pdf}  \label{fig: hist_cal_13}}
	\subfloat[S26 - 2AY]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_14.pdf}  \label{fig: hist_cal_14}}
	\subfloat[S27 - 1BY]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_15.pdf}  \label{fig: hist_cal_15}}
	\subfloat[S28 - 2BY]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_16.pdf}  \label{fig: hist_cal_16}} \\
	\subfloat[M1 - Łuk]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_17.pdf}  \label{fig: hist_cal_17}}
	\subfloat[M2 - Ściąg]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_18.pdf}  \label{fig: hist_cal_18}}
	\subfloat[M3 - Tłuczeń 1]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_19.pdf}  \label{fig: hist_cal_19}}
	\subfloat[M4 - Tłuczeń 2]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_20.pdf}  \label{fig: hist_cal_20}} \\
	\subfloat[M5 - Pomost]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_21.pdf}  \label{fig: hist_cal_21}}
	\subfloat[M6 Stężenia]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_22.pdf}  \label{fig: hist_cal_22}}
...
\begin{table}[hbt!]
	...
	\begin{tabular}{@{}p{0.15\linewidth} *8{P{0.10625\linewidth}}@{}}
		\toprule
		\textbf{Element}    & Łuk  & Ściąg & Poprzecz. & Żebra & Płyta & Stężenia & Wieszak & Wezgłowie \\ \midrule
		\textbf{Oznaczenie} & S1   & S2    & S3           & S4    & S5    & S6       & S7      & S8        \\ \midrule
		\textbf{Mnożnik}    & 0.93 & 1.17  & 1.10         & 0.99   & 1.02  & 0.99      & 1.08     & 8.81       \\ \bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[hbt!]
	...
	\begin{tabular}{@{}p{0.15\linewidth} *8{P{0.10625\linewidth}}@{}}
		...
		\textbf{Mnożnik}   & $1\mathrm{E}{-1.69}$ & $1\mathrm{E}{-5.63}$ & $1\mathrm{E}{5.02}$ & $1\mathrm{E}{-1.66}$ & $1\mathrm{E}{-0.46}$ & $1\mathrm{E}{1.96}$ & $1\mathrm{E}{3.71}$ & $1\mathrm{E}{-1.81}$ \\ \bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[hbt!]
	...
	\begin{tabular}{@{}p{0.15\linewidth} *6{P{0.1417\linewidth}}@{}}
		...
		\textbf{Mnożnik}   & 0.81 & 0.96   & 0.68       & 0.76       & 0.80    & 1.02       \\ \bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[hbt!]
	...
	%\begin{tabular}{@{}lccccccccc@{}}
		\toprule
		\multicolumn{1}{c}{\multirow{2}{*}{\textbf{Źródło}}}                       & \multicolumn{3}{c}{\textbf{Częstotliwości}} & \multicolumn{3}{c}{\textbf{Próbne obciążenie U1}} & \multicolumn{3}{c}{\textbf{Próbne obciążenie U2}} \\ \cmidrule(l){2-10} 
		\multicolumn{1}{c}{}                                              & $f_1$      & $f_2$       & $f_3$      & P1/4         & P2/4        & P3/4        & P1/4        & P2/4         & P3/4        \\ \midrule
		\textbf{Model 2D }                                                         & 2.49      & 3.43       & 5.54      & -16.20       & -7.86       & 6.51        & -2.49       & -11.68       & -8.30       \\ \midrule
		\begin{tabular}[c]{@{}l@{}}\textbf{Konstrukcja}\\ \textbf{rzeczywista}\end{tabular} & 2.52      & 3.43       & 5.84      & -16.30       & -8.26       & 5.83        & -2.66       & -11.49       & -8.06       \\ \midrule
		\textbf{Porównanie }                                                       & 99\%      & 100\%      & 95\%      & 100\%        & 95\%        & 112\%       & 94\%        & 102\%        & 103\%       \\ \bottomrule
	\end{tabular}
...
\begin{table}[hbt!]
	...
	%\begin{tabular}{@{}lccc@{}}
		...
		\textbf{Zakres   zmienności [mm]} & $150 - 2 500$ & $1 000 - 4 500$ & $10 - 200$       \\ \bottomrule
	\end{tabular}
...
Dodatkowo dla każdego z wariantów wieszaków i prędkości z wykresów na rysunku \ref{fig:comparison_diffs_opt} odczytano wartość minimalną i maksymalną przyspieszeń odpowiadających masom przedstawionych w tabeli \ref{tab:summary_optimal_results}. Są to skrajne wartości pasków przeciętych przez pionową linię przerywaną. Rezultaty przedstawiono w tabeli \ref{tab:optimization_dynamic_ranges}\footnote{ 
...
\begin{table}[hbt!]
	\caption{Zestawienie ekstremalnych przyspieszeń maksymalnych uzyskanych dla masy konstrukcji spełniającej wymóg normowy ograniczenia przyspieszeń pomostu}
	\centering
	\footnotesize
	\setlength\tabcolsep{0pt}

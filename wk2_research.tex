...
\begin{itemize}
	...
	\end{itemize}
	\item Sztywność warunków brzegowych:
	\begin{itemize}
	...
	\begin{itemize}
		\item M1 - łuku,
		\item M2 - ściągu,
		\item M3 - tłucznia - część 1,
		\item M4 - tłucznia - część 2,
		\item M5 - pomostu roboczego,
		\item M6 - stężeń górnych.
	\end{itemize}
\end{itemize}
\textbf{DODAĆ RYSUNEK ŁOŻYSKOWANIA Z PUNKTAMI S21-S28}


Do modyfikacji parametrów modelu zastosowano wielokryterialną optymalizację za pomocą algorytmu MOPSO \ref{!!!}. 

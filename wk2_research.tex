...
\begin{figure}[hbt!]
	\centering
	\subfloat[]{\includegraphics[width=\linewidth]{/WK2/model/tluczen_calosc.jpg} \label{fig: model_wk2_balast_loadcase_a}} \\
	\subfloat[]{\includegraphics[width=\linewidth]{/WK2/model/tluczen_luk.jpg}

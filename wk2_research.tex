...
\begin{figure}[hbt!]
	\centering
	\subfloat[wieszaki pionowe]{\includegraphics[width=0.46\textwidth,trim=40 27 5 27, clip]{WK2/opti/proste_160/proste_160_FREQ_MIN_MAC_XY.pdf}}
	\subfloat[wieszaki ukośne]{\includegraphics[width=0.46\textwidth,trim=40 27 5 27, clip]{WK2/opti/niels_160/niels_160_FREQ_MIN_MAC_XY.pdf}} \\
	\subfloat[wieszaki Network]{\includegraphics[width=0.46\textwidth,trim=40 27 5 27, clip]{WK2/opti/netw_160/netw_160_FREQ_MIN_MAC_XY.pdf}}
...
Mając wystarczającą pewność co do poprawności podziału na postaci drgań, na kolejnych rysunkach przedstawiono wartości funkcji celu oraz zmiennych projektowych z przeprowadzonych optymalizacji, w zależności od pierwszych dwóch częstotliwości drgań własnych.
...
\begin{figure}[hbt!]
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_example}}
	\subfloat[]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_DEC_FREC_XY.pdf}  \label{fig:opti_res_2_freqs_prost_200_example}}
...
Rozwiązania dla danego układu wieszaków ukazują pewne zależności niezależne od ograniczenia prędkości maksymalnej. Dla kolejnych wariantów prędkości nie powielano tych wspólnych elementów w opisie.

%\begin{figure}[H]
%	\centering
%	\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_DEC_FREC_XY.pdf}
%	\caption{Przykładowy rezultat pokazujący postać drgań związany z częstotliwością drgań własnych decydującą o prędkości krytycznej wywołującej największe przyspieszenia pomostu}
%		\label{fig:opti_res_2_freqs_prost_200_example}
%		
%\end{figure}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_160/proste_160_FREQ_WIESZAK_XY.pdf}}
...
\begin{figure}[H]\ContinuedFloat
		\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_d}}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_200/proste_200_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_e1}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
...
Analizy powyższych danych pozwalają na wyciągnięcie następujących wniosków dla wariantu z wieszakami pionowymi i prędkości maksymalnej 200 km/h:
\begin{enumerate}
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_b}}
	\label{fig:opti_res_2_freqs_prost_300}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_d}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_e1}}
...
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_f}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/proste_300/proste_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami pionowymi i prędkością maksymalną 300 km/h:
\begin{enumerate}
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_b}}
\end{figure}


\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_d}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_e1}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_f}}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_160/niels_160_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_h}}
...
\begin{enumerate}
	...
	\item Wyraźnie zarysowuje się również korelacja pomiędzy częstotliwością drgań własnych o postaci z podwójną półfalą, a średnicą wieszaka (rys. \ref{fig:opti_res_2_freqs_niels_160_e1}). Zależność ta wydaje się być silniejsza niż dla wysokości ściągu.
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_b}}
\end{figure}	

\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_d}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_e1}}
\end{figure}	
\begin{figure}[H]\ContinuedFloat
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_f}}

\end{figure}

\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_200/niels_200_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami ukośnymi i prędkością maksymalną 200 km/h:
\begin{enumerate}
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_b}}
\end{figure}

\begin{figure}[H]\ContinuedFloat
		\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_d}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
		\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.49\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_e1}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
		\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.49\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_e}}
	\subfloat[prędkość decydująca]{\includegraphics[width=0.49\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_f}}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.49\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.49\textwidth,trim=40 25 5 25, clip]{WK2/opti/niels_300/niels_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_h}}
	\caption{Rezultaty optymalizacji w dziedzinie dwóch pierwszych częstotliwości drgań własnych, z rozróżnieniem postaci drgań - wariant z wieszakami ukośnymi - prędkość maksymalna 300 km/h. Kont.}
\end{figure}

Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami ukośnymi i prędkością maksymalną 300 km/h:
\begin{enumerate}
	
	\item Podobnie jak w prędkości 200 km/h, a w odróżnieniu do wariantu z prędkością 160 km/h pojawiają się widoczne skoki wielkości przyspieszeń (rys. \ref{fig:opti_res_2_freqs_niels_300_b}). Pokrywają się one z częstotliwościami $f_{300,1}^{max\,A1}$ i $f_{300,1}^{max\,A10}$ dla częstotliwości o postaci z podwójną półfalą.
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_b}}

\end{figure}
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_d}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_e1}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_f}}

\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_HSLM_DEC_XY.pdf}  \label{fig:opti_res_2_freqs_netw_160_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_160/netw_160_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_h}}
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_netw_200_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_ACC_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_b}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_SCIAG_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_LUK_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_d}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_WIESZAK_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_e1}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_DEC_FREC_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_VELOCITY_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_f}} 

\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_HSLM_DEC_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_200/netw_200_FREQ_VCR_DIV_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami Network i prędkością maksymalną 200 km/h:
\begin{enumerate}
	
	\item Wszystkie otrzymane rozwiązania mieszczą się powyżej granicy $f_{200,1}^{max\,A1}$ dla częstotliwości drgań własnych o postaci z podwójną półfalą. W zakresie otrzymanych częstotliwości drgań własnych dla postaci z pojedynczą półfalą pojawia częstotliwość graniczna $f_{200,1}^{max\,A1}$. Do momentu jej uzyskania przez rozwiązania, decydująca jest postać o jednej półfali. Po jej przekroczeniu pojawia się pole gdzie decydująca jest postać drgań z podwójną półfalą.
...
\begin{figure}[H]
	\centering
	\subfloat[masa konstrukcji]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_WEI_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_a}}
	\subfloat[maksymalne przyspieszenia]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_ACC_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_b}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[wysokość ściągu]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_SCIAG_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_c}}
	\subfloat[wysokość łuku]{\includegraphics[width=0.48\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_LUK_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_d}}
		\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[średnica wieszaka]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_WIESZAK_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_e1}}
\end{figure}
\begin{figure}[H]\ContinuedFloat
\centering
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_e}} \hfill
	\subfloat[prędkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_f}}

\end{figure}
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_g}}
	\subfloat[dzielnik $k$ przy obliczaniu decydującej prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 25 5 25, clip]{WK2/opti/netw_300/netw_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami Network i prędkością maksymalną 300 km/h:
\begin{enumerate}

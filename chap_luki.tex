...
\begin{itemize}
	\item pomost usytuowany w całości nad łukiem - z jazdą górą (Rys. \ref{fig:bri_deck_loc_top}),
	\item pomost usytuowany w całości poniżej łuku - z jazdą dołem (Rys. \ref{fig:bri_deck_loc_middle}),
	\item pomost usytuowany pośrednio - z jazdą pośrednią (Rys. \ref{fig:bri_deck_loc_bott}).
\end{itemize}
...
\begin{figure}[bt!]
	\centering
	\captionsetup{justification=centering}
	\subfloat[Wiadukt w Lalikach Wielkich k/Zwardonia (fot. Kazimierz Flaga)]{\includegraphics[width=0.48\linewidth]{/mosty_wstep/photos/zelbet_lukowy_lalikach_wielkich_fot_kaz_flaga.jpg}} \;
	\subfloat[Most im. Marszałka Józefa Piłsudzkiego w Krakowie\\(fot. Jakub Hałun/wikipedia.org)]{\includegraphics[width=0.48\linewidth]{/mosty_wstep/photos/Krakow_most_Pilsudskiego.jpg}} \\
	\subfloat[Most im. Jana Pawła II w Puławach\\(fot. Kamil Lewandowski/Gmina Puławy)]{\includegraphics[width=0.48\linewidth]{/mosty_wstep/photos/most_pulawy.jpg}} \;
	\subfloat[Most na Dziwnie w ciągu obwodnicy Wolina\\(fot. Radosław Drożdżewski)]{\includegraphics[width=0.48\linewidth]{/mosty_wstep/photos/Wolin_-_most_obwodowy_DK3_d_radoslaw_drozdzewski.jpg}}

	\caption{Wybrane polskie mosty łukowe: (a) wiadukt z jazdą górą, (b) most z jazdą dołem i dźwigarem kratowym, (c) most z jazdą pośrednią, (d) most z jazdą dołem}
...
\begin{itemize}
	\item pełnościenny przekrój łuku (dźwigar stalowy),
	\item łuk w postaci kratownicy (dźwigar stalowy),
	\item pełny przekrój lub w postaci skrzynki (dźwigar betonowy).
	\item zespolony przekrój ze stalowym płaszczem wypełnionym betonem \teng{CFST - Concrete Filled Steel Tubes}.
\end{itemize}
...
W przypadku obiektów z jazdą dołem występują trzy główne schematy rozkłady wieszaków:
\begin{itemize}
	\item wieszaki proste,
	\item wieszaki ukośne,
	\item wieszaki typu Network.
\end{itemize}

Wieszaki proste są tradycyjnym rozwiązaniem i nie wymagają szerszego omówienia. System wieszaków ukośnych został zaproponowany przez Octaviusa F. Nielsena w roku 1926. Przyczynkiem do opracowania tego rozwiązania było zjawisko wyłączania się niektórych wieszaków prostych przy obciążeniu ruchomym. W systemie Nielsena nie przewidziano przecinania się wieszaków. W roku 1955 Per Tveit w swojej pracy magisterskiej zaproponował rozwiązanie, w którym niektóre z wieszaków przecinają się przynajmniej dwukrotnie \parencite{Tveit2019}. System ten nazwano z języka angielskiego jako Network. \cite{Tveit2019} podaje zalety wynikające z zastosowania wieszaków typu Network. Poniżej przytoczono kilka najważniejszych:
\begin{itemize}
	\item zapewniają najmniejszą smukłość i lekkość konstrukcji spośród wszystkich wariantów konstrukcji łukowych,
	\item znajdują zastosowanie zarówno w mostach drogowych jak i kolejowych,
	\item większa sztywność globalna konstrukcji - mniejsze ugięcia i mniejsze obroty na podporach.
\end{itemize}
W ocenie 


- typy wieszaków - sztywne przegubowe

 zagrożenie drganiami wieszaków - Huta zawadzka, Zobel Zoltowski
- mosty z pomostem usytuowanym powyżej łuku 
Strzałki (Pszenicki Madaj)

\begin{figure}[h]
	\centering
	\subfloat[wieszki proste]{\includegraphics[width=0.7\linewidth,page=1]{/mosty_wstep/mosty.pdf}}  \\
	\subfloat[wieszaki ukośne]{\includegraphics[width=0.7\linewidth,page=2]{/mosty_wstep/mosty.pdf}} \\
	\subfloat[wieszaki typu Network]{\includegraphics[width=0.7\linewidth,page=3]{/mosty_wstep/mosty.pdf}}
	\captionsetup{justification=centering}

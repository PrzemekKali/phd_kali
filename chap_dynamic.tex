...
Uwzględnienie efektów dynamicznych przy projektowaniu i w ocenie mostów może odbywać się na wiele sposobów. Według obecnych przepisów i norm uwzględnienie efektów oddziaływań dynamicznych może odbyć się na dwa główne sposoby:
\begin{enumerate}
	...
	\item przez wyznaczenie odpowiedzi dynamicznej układu pod obciążeniem ruchomym.
\end{enumerate}
...
Druga rodzina metod opiera na wyznaczeniu odpowiedzi układu pod wpływem przejazdu poprzez wykonanie analizy dynamicznej. Stosowane podejścia różnią się stopniem złożoności i liczbą uwzględnianych czynników. Pierwsze rozwiązania analityczne drgań konstrukcji z obciążeniem ruchomym dla elementarnych modeli mechanicznych pojawiły się już XIX w. Prace \parencite{Willis1849,Stokes1849,Timoshenko1922,Inglis1934,Kolousek1973} stanowią kamienie milowe w historii rozwoju metod wyznaczania odpowiedzi w mostach pod obciążeniem ruchomym. 



Jedną z najprostszych metod jest wyznaczenie maksymalnych przyspieszeń za pomocą Dynamicznej Sygnatury Pociągu \teng{Dynamic Train Signature} \parencite{Goicolea2008,ERRI1998}. Chociaż ma ona zastosowanie jedynie do najprostszego układu belki wolno podpartej to jej niewątpliwą zaletą jest to, że nie wymaga stosowania złożonych metod numerycznych do uzyskania wyniku. W metodzie uwzględnia się charakterystyki dynamiczne układu, dynamiczną linię wpływu \teng{dynamic influence line} mostu oraz sygnaturę dynamiczną pociągu. Wspomniana sygnatura dynamiczna pociągu jest krzywą określoną indywidualnie dla danego taboru i jest niezależna od cech mechanicznych przęsła, a jedynie od typowego rozstawu osi pociągu oraz tłumienia w układzie.

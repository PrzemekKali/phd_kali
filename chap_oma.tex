...
\end{equation} 
w którym $\Delta t$ oznacza krok czasowy próbkowania, taki że $\Delta t = 1/f_s$, gdzie $f_s$ jest częstotliwością próbkowania pomiaru. Częstość drgań własnych $\omega_{n,i}$ oraz towarzyszące tłumienie $\xi_i$ wyznaczyć można na podstaw wartości własnych zebranych w macierzy $\vect{\Lambda}_c$, a postaci drgań własnych $\vect{\phi}_i$ z macierzy $\vect{\Phi}$ za pomocą następujących formuł:
\begin{equation}
...
\begin{figure}[h]
	\centering
	\subfloat[Diagram niefiltrowany]{\includegraphics[width=\linewidth, trim=6 0 6 0, clip ]{/test_blue/stab_diag_lab/fig_stab_diagram_nonfiltr_time_17_49_58.pdf}}\\
	\subfloat[Diagram filtrowany]{\includegraphics[width=\linewidth, trim=6 0 6 0, clip]{/test_blue/stab_diag_lab/fig_stab_diagram_filtr_time_17_49_52.pdf}}%
	\captionsetup{justification=centering}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[trim=0 8 0 17,clip]{/test_blue/fig_00_12_14_0.978.pdf}
	\captionsetup{justification=centering}

...
\begin{figure}[hbt!]
	...
	\subfloat[widok przestrzenny]{\includegraphics[width=0.48\linewidth,trim =0 0 0 0 ,clip]{/WK2/kalibracja/fig_all_paricles_AXO.jpg} \label{fig: calibration_paretoa}} \quad
	\subfloat[rzut na płaszczyznę $f_{freq}f_{MAC}$]{\includegraphics[width=0.42\linewidth,trim =0 0 0 0 ,clip]{/WK2/kalibracja/fig_all_paricles_XY.jpg} \label{fig: calibration_paretob}} \\
	\subfloat[ rzut na płaszczyznę $f_{disp}f_{MAC}$]{\includegraphics[width=0.42\linewidth,trim =0 0 0 0 ,clip]{/WK2/kalibracja/fig_all_paricles_YZ.jpg} \label{fig: calibration_paretoc}} \qquad
	\subfloat[rzut na płaszczyznę $f_{freq}f_{disp}$]{\includegraphics[width=0.42\linewidth,trim =0 0 0 0 ,clip]{/WK2/kalibracja/fig_all_paricles_XZ.jpg} \label{fig: calibration_paretod}}
	\captionsetup{justification=centering}
...
W procesie optymalizacji uwzględniono również ograniczenia i wymagania, jakie musi spełnić rozwiązanie, aby zostało uznane za poprawne. Wartości podlegające ograniczeniom zestawiono w wektorze $\vect{C}=[c_{sa},c_{sg},c_{sh},c_{d}]$ i wyznaczono je na podstawie przepisów normowych \parencite{PKNc,PKNj} jako:
\begin{itemize}
...
\begin{figure}[p]
	\centering
	\subfloat[wieszaki pionowe,\\ $v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 0, clip]{WK2/opti/proste_160/proste_160_diffs.pdf}} \hfill
	\subfloat[wieszaki pionowe,\\ $v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/proste_200/proste_200_diffs.pdf}} \hfill
	\subfloat[wieszaki pionowe,\\ $v_{max} = 300$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/proste_300/proste_300_diffs.pdf}}\\
	\subfloat[wieszaki ukośne,\\ $v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 0, clip]{WK2/opti/niels_160/niels_160_diffs.pdf}} \hfill
	\subfloat[wieszaki ukośne,\\ $v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/niels_200/niels_200_diffs.pdf}} \hfill
	\subfloat[wieszaki ukośne,\\ $v_{max} = 300$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/niels_300/niels_300_diffs.pdf}}\\
	\subfloat[wieszaki Network,\\$v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 0, clip]{WK2/opti/netw_160/netw_160_diffs.pdf}} \hfill
	\subfloat[wieszaki Network,\\$v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/netw_200/netw_200_diffs.pdf}} \hfill
	\subfloat[wieszaki Network,\\$v_{max} = 300$ km/h]{\includegraphics[trim= 20  5 05 0, clip]{WK2/opti/netw_300/netw_300_diffs.pdf}}
	\captionsetup{justification=centering}

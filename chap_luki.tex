...
\begin{itemize}[noitemsep]
	\item wieszaki proste (Rys. \ref{fig:bridges_types_hangers_a}),
	\item wieszaki ukośne - Nielsena (Rys. \ref{fig:bridges_types_hangers_b}),
	\item wieszaki typu Network (Rys. \ref{fig:bridges_types_hangers_c}).
\end{itemize}

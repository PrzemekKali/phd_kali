...
\begin{figure}[h]
	...
	\subfloat[Diagram filtrowany]{\includegraphics[width=\linewidth]{/test_blue/stab_diag/fig_stab_diagram_filtr_time_22_33_13.pdf},\label{fig: stab_diags_blue_beam_b}}%
...
\begin{figure}[h]
	...
	\begin{tabular}[c]{c}
		\subfloat[Mod 1, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod1}%
			\begin{tabular}[b]{c c}
				\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_0_time_00_17_57.pdf}%
				\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_0_time_00_19_14.pdf}%
			\end{tabular}}\\
		
		\subfloat[Mod 2, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod2}%
			\begin{tabular}[b]{c c}
				\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_2_time_00_19_31.pdf}%
				\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_2_time_00_19_46.pdf}%
		\end{tabular}}\\
		\subfloat[Mod 3, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod3}%
		\begin{tabular}[b]{c c}
			\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_4_time_00_20_17.pdf}%
			\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_4_time_00_20_25.pdf}%
		
	\end{tabular}}\\
		\subfloat[Mod 4, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod4}%
	\begin{tabular}[b]{c c}
		\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_6_time_00_20_53.pdf}%
		\includegraphics[width=0.5\linewidth]{/test_blue/blue_modes/fig_mod_6_time_00_21_00.pdf}%
\end{tabular}}\\
	\end{tabular}

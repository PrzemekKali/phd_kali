...
\begin{figure}[h]
	\centering
	\subfloat[$f_1=2.49\,\text{Hz}$]{\includegraphics[width=0.8\textwidth]{/WK2/model_upr/plaski_ogolny_mod_1.jpg} }\\
	\subfloat[$f_2=3.43\,\text{Hz}$]{\includegraphics[width=0.8\textwidth]{/WK2/model_upr/plaski_ogolny_mod_2.jpg} }\\
	\subfloat[$f_3=5.54\,\text{Hz}$]{\includegraphics[width=0.8\textwidth]{/WK2/model_upr/plaski_ogolny_mod_3.jpg} }
	\captionsetup{justification=centering}
...
Model stworzono w trzech wariantach różniących się rozmieszczeniem wieszaków. Przyjęte układy podwieszenia pomostu do łuku pokazano na rysunku \ref{}.

...
\textit{Streszczenie: W niniejszym rozdziale przytoczono podstawowe modele matematyczne opisujące ruch drgający. W klasycznym ujęciu wywód rozpoczęto od przytoczenia rozwiązań dla jednego stopnia swobody. Przedstawiono rozwiązanie dynamicznego problemu własnego - analizy modalnej. W dalszej części przytoczono metody wyznaczania odpowiedzi dynamicznej modelu o jednym i wielu stopniach swobody obliczanych w sposób analityczny oraz numeryczny. Na końcu rozdziału omówiono metodę uwzględniania tłumienia w obliczeniach.}

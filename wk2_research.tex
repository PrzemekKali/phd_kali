...
W trakcie kalibracji wyznaczono funkcję celu dla 97 867 położeń cząstek. Wszystkie wyniki zachowano w bazie wiedzy. Front Pareto po ostatniej iteracji złożony był z 8100 cząstek. Na rysunku \ref{fig: calibration_pareto} pokazano $\epsilon-$Pareto Front w widoku przestrzennym i w rzutach na wszystkie płaszczyzny. Kolor cząstek oznacza sumę algebraiczną wszystkich funkcji celu $\vect{F}$. Gdyby wykonać optymalizację jednokryterialną, przy osiągnięciu dokładnie tych samych położeń cząstek byłby to jedyny wynik i oznaczałby minimum globalne. Dzięki wykonaniu optymalizacji wielokryterialnej możliwy jest wybór różnych wag dla poszczególnych kryteriów oraz ocena wybranego kompromisu wśród całego zbioru rozwiązań optymalnych.

\begin{figure}[hbt!]
	\centering
	%width=0.48\linewidth
	\subfloat[]{\includegraphics[trim =3 5 5 15 ,clip]{/WK2/kalibracja/fig_all_paricles_AXO.pdf} \label{fig: calibration_paretoa}}
	\subfloat[]{\includegraphics[trim =20 15 5 5 ,clip]{/WK2/kalibracja/fig_all_paricles_XY.pdf} \label{fig: calibration_paretob}} \\
	\subfloat[]{\includegraphics[trim =15 18 5 20 ,clip]{/WK2/kalibracja/fig_all_paricles_YZ.pdf} \label{fig: calibration_paretoc}}
	\subfloat[]{\includegraphics[trim =20 18 5 20 ,clip]{/WK2/kalibracja/fig_all_paricles_XZ.pdf} \label{fig: calibration_paretod}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]
	\centering
	\subfloat[]{\includegraphics[trim =3 5 5 10 ,clip]{/WK2/kalibracja/fig_all_paricles_AXO_selected.pdf} }
	\subfloat[]{\includegraphics[trim =10 10 5 5 ,clip]{/WK2/kalibracja/fig_all_paricles_XY_selected.pdf} } \\
	\subfloat[]{\includegraphics[trim =10 5 5 20 ,clip]{/WK2/kalibracja/fig_all_paricles_YZ_selected.pdf}}
	\subfloat[]{\includegraphics[trim =10 5 5 20 ,clip]{/WK2/kalibracja/fig_all_paricles_XZ_selected.pdf} }
	\captionsetup{justification=centering}
...
\begin{figure}[p]
	\centering
	%width=0.48\linewidth
\subfloat[S1]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_1.pdf}  \label{fig: hist_cal_1}}
\subfloat[S2]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_2.pdf}  \label{fig: hist_cal_2}}
\subfloat[S3]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_3.pdf}  \label{fig: hist_cal_3}}
\subfloat[S4]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_4.pdf}  \label{fig: hist_cal_4}} \\
\subfloat[S5]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_5.pdf}  \label{fig: hist_cal_5}}
\subfloat[S6]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_6.pdf}  \label{fig: hist_cal_6}}
\subfloat[S7]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_7.pdf}  \label{fig: hist_cal_7}}
\subfloat[S8]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_8.pdf}  \label{fig: hist_cal_8}} \\ 
\subfloat[S21]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_9.pdf}  \label{fig: hist_cal_9}}
\subfloat[S22]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_10.pdf}  \label{fig: hist_cal_10}}
\subfloat[S23]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_11.pdf}  \label{fig: hist_cal_11}}
\subfloat[S24]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_12.pdf}  \label{fig: hist_cal_12}} \\
\subfloat[S25]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_13.pdf}  \label{fig: hist_cal_13}}
\subfloat[S26]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_14.pdf}  \label{fig: hist_cal_14}}
\subfloat[S27]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_15.pdf}  \label{fig: hist_cal_15}}
\subfloat[S28]{\includegraphics[width=0.25\linewidth,trim= 2 7 0 7,clip]{/WK2/kalibracja/fig_hist_param_16.pdf}  \label{fig: hist_cal_16}} \\
\subfloat[M1]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_17.pdf}  \label{fig: hist_cal_17}}
\subfloat[M2]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_18.pdf}  \label{fig: hist_cal_18}}
\subfloat[M3]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_19.pdf}  \label{fig: hist_cal_19}}
\subfloat[M4]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_20.pdf}  \label{fig: hist_cal_20}} \\
\subfloat[M5]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_21.pdf}  \label{fig: hist_cal_21}}
\subfloat[M6]{\includegraphics[ width=0.25\linewidth,trim= 2 8 0 7,clip]{/WK2/kalibracja/fig_hist_param_22.pdf}  \label{fig: hist_cal_22}}

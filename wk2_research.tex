...
\end{tabular}}\\
	...
	\end{tabular}
\caption{Zidentyfikowane charakterystyki modalne wiaduktu WK2. Od lewej: składowe Z wektora postaci drgań własnych (pionowe); składowe Y wektora postaci drgań własnych (poprzeczne); wszystkie składowe wektora postaci drgań własnych na płaszczyźnie zespolonej.}
...
\end{tabular}}\\
	\end{tabular}
\caption{Zidentyfikowane charakterystyki modalne wiaduktu WK2. Od lewej: składowe Z wektora postaci drgań własnych (pionowe); składowe Y wektora postaci drgań własnych (poprzeczne); wszystkie składowe wektora postaci drgań własnych na płaszczyźnie zespolonej. Kont.}
...
\begin{figure}[p]
	\centering
	\subfloat[Proste,\\ $v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 05, clip]{WK2/opti/proste_160/proste_160_diffs.pdf}} \hfill
	\subfloat[Proste,\\ $v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 05, clip]{WK2/opti/proste_200/proste_200_diffs.pdf}} \hfill
	\subfloat[Proste,\\ $v_{max} = 300$ km/h]{\includegraphics[trim= 20  5 05 05, clip]{WK2/opti/proste_300/proste_300_diffs.pdf}}\\
	\subfloat[Ukośne,\\ $v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 05, clip]{WK2/opti/niels_160/niels_160_diffs.pdf}} \hfill
	\subfloat[Ukośne,\\ $v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 05, clip]{WK2/opti/niels_200/niels_200_diffs.pdf}} \hfill
	\subfloat[Ukośne,\\ $v_{max} = 300$ km/h]{\includegraphics[trim= 20  5 05 05, clip]{WK2/opti/niels_300/niels_300_diffs.pdf}}\\
	\subfloat[Network,\\$v_{max} = 160$ km/h]{\includegraphics[trim= 07  5 05 05, clip]{WK2/opti/netw_160/netw_160_diffs.pdf}} \hfill
	\subfloat[Network,\\$v_{max} = 200$ km/h]{\includegraphics[trim= 20  5 05 05, clip]{WK2/opti/netw_200/netw_200_diffs.pdf}} \hfill
...
\begin{itemize}
	...
	\item (h) dzielnik prędkości krytycznej, dla przypadku wywołującego maksymalne przyspieszenia pomostu. W przypadku decydujacej prędkości maksymalnej przyjęto 0.
\end{itemize}
...
Na rysunkach (a-d) zielonym, prostokątnym obrysem zaznaczono obszar zawierający wszystkie rozwiązania z przyspieszeniami maksymalnymi pomostu mniejszymi niż $3.5\;\mathrm{m/s^2}$. Czerwony trójkąt oznacza \enquote{najlepsze} rozwiązanie - minimalna masa konstrukcji i jednocześnie przyspieszenia spełniające warunek $3.5\;\mathrm{m/s^2}$ (Tablica \ref{tab:summary_optimal_results}).

Na rysunkach (e-h) zaznaczono czarnymi i czerwonymi liniami przerywanymi pewne charakterystyczne częstotliwości $f_{v,k}^{min/max}$. Obliczono je przyrównując prędkość maksymalną przejazdu $v_{max}$ (odpowiednio 160, 200 lub 300 km/h) do prędkości rezonansowej $c_{cr}$ dla modeli obciążenia:
\begin{itemize}
...
\end{itemize}  
i dzielników prędkości krytycznej równych $k = 1, 2, 3\;\mathrm{lub}\;4$ według wzoru (\ref{eq:critical_speed_2}). Przykładowo dla przypadku prędkości maksymalnej $v_{max}=160 \mathrm{km/h}$ i dzielnika $k=1$ otrzymano następujące częstotliwości:
\begin{equation*}
	\begin{split}
	f_{160,1}^{max} &= \frac{160}{3.6} \cdot \frac{1}{18}=2.47\,\mathrm{Hz} \\
	f_{160,1}^{min} &= \frac{160}{3.6} \cdot \frac{1}{27}=1.64\,\mathrm{Hz}
	\end{split}
\end{equation*} 
Interpretacja tych częstotliwości jest następująca: jeżeli częstotliwość drgań własnych konstrukcji jest większa od wartości $f_{160,1}^{max}$ (linia czarna) to dla wszystkich pojazdów HSLM-A pierwsza prędkość krytyczna (dla $k=1$) jest większa od maksymalnej możliwej prędkości na linii. Oznacza to, że wymagane jest zwiększenie dzielnika $k$ do uzyskania prędkości krytycznej, mniejszej lub równej maksymalnej dopuszczalnej. Częstotliwość oznaczona jako minimalna $f_{160,1}^{min}$ (linia czerwona) oznacza, że od tego miejsca rozpoczyna się konieczne zmniejszanie prędkości rezonansowych dzielnikiem $k$ dla kolejnych modeli pociagów HSLM-A. W obszarze od linii czerwonej do czarnej o tym samym dzielniku $k$ kolejne pociągi licząc od A10 do A1 wychodzą z prędkością rezonansową powyżej prędkości maksymalnej i zwiększony musi być dla nich dzielnik $k$. Pomiędzy linią czarną $k$ i linią czerwoną $k+1$, dzielnik jest stały dla wszystkich modeli i równy $k$.

\clearpage

\subsubsection{Wariant z wieszakami prostymi, prędkość maksymalna 160 km/h}
\begin{figure}[H]
	\centering
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami prostymi i prędkością maksymalną 160 km/h.
\begin{enumerate}
	...
	\end{itemize}
	\item Maksymalne przyspieszenia charakteryzują się skokowymi zmianami dla częstotliwości drgań własnych o podwójnej półfali (Rys. \ref{fig:opti_res_2_freqs_prost_160_a}). Granice te pokrywają się z częstotliwościami $f_{160,1}^{min}$ i $f_{160,1}^{min}$ postaci z podwójną półfalą. 
	...
	\item W większości przeanalizowanych przypadków decydująca o maksymalnych przyspieszeniach jest prędkość krytyczna związana z częstotliwością o postaci z podwójną półfalą (Rys. \ref{fig:opti_res_2_freqs_prost_160_e}). Dopiero po przekroczeniu częstotliwości ok 4.2 Hz najgorsze przyspieszenia uzyskuje się dla częstotliwości drgań związanych o postaci z pojedynczą półfalą.

\end{enumerate}
\vfill

\subsubsection{Wariant z wieszakami prostymi, prędkość maksymalna 200 km/h}
\begin{figure}[H]
	\centering
	...
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.47\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_DEC_FREC_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_e}} \hfill
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_f}}
...
\begin{figure}[H]\ContinuedFloat
	\centering
	\subfloat[decydujący model HSLM-A]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_HSLM_DEC_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_g}}
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_200/proste_200_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_prost_200_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami prostymi i prędkością maksymalną 200 km/h. W większości pokrywają się one z wynikami analizy o prędkości maksymalnej 160 km/h.
\begin{enumerate}
	...
	\item W porównaniu do wariantu z prędkością maksymalną 160 km/h, prędkość krytyczna związana z częstotliwością o postaci z pojedynczą półfalą stanowi większą część rozwiązań (Rys. \ref{fig:opti_res_2_freqs_prost_200_e}). Rozwiązania dla przypadków prędkośći krytycznych z dzielnikiem $k>1$ dla postaci z podwójną półfalą i $k=1$ dla postaci z pojedynczą półfalą charakteryzyją się nieznacznie większymi przyspieszeniami maksymalnymi. Niemniej jest to różnica niewielka i nie wyklucza tych rozwiązań z grupy rozwiązań dopuszczalnych.
\end{enumerate}
\vfill
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_f}}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/proste_300/proste_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_prost_300_h}}
...
Analiza powyższych wizualizacji danych pozwala na wyciągnięcie następujących wniosków dla wariantu z wieszakami prostymi i prędkością maksymalną 300 km/h. W większości pokrywają się one z wynikami analiz o prędkościach maksymalnych 160 i 200 km/h.
\begin{enumerate}
	\item Maksymalne przyspieszenia charakteryzują się skokowymi zmianami dla częstotliwości drgań własnych o podwójnej półfali (Rys. \ref{fig:opti_res_2_freqs_prost_300_a}). Granice te pokrywają się z częstotliwościami $f_{300,1}^{min}$ i $f_{300,1}^{min}$ postaci z podwójną półfalą. 
	...
	\item Ze względu na wysoką prędkość przejazdu częstotliwości graniczną $f_{300,1}^{min}$ i $f_{300,1}^{min}$ są znacznie wyższe niż w poprzednich analizach. Dla postaci z jedną półfalą wszystkie rozwiązania mieszczą się poniżej $f_{300,1}^{min}$.
\end{enumerate}
\vfill
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_f}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_160/niels_160_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_160_h}}
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_f}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_200/niels_200_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_200_h}}
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_f}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/niels_300/niels_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_niels_300_h}}
...
\begin{enumerate}
	...
	\item Poniżej granicy $f_{300,1}^{max}$ dla częstotliwości o postaci z podwójną półfalą decydująca jest właśnie ta częstotliwość, a powyżej tej granicy przede wszystkim decyduje częstotliwość związana z postacią o jednej półfali.
	...
	\item Przyspieszenia dopuszczalne $a_{max}<3.5\;\mathrm{m/s^2}$ otrzymano jedynie dla rozwiązań, dla których częstotliwość graniczna $f_{300,1}^{max}$ została przekroczona dla częstotliwości o postaci z podwójną półfalą (Rys \ref{fig:opti_res_2_freqs_niels_300_b} i \ref{fig:opti_res_2_freqs_niels_300_e}). Spełnienie tego warunku wydaje się być konieczne, ale nie wystarczające aby zapewnić odpowiednio niski poziom przyspieszeń. Kiedy decydująca staje się częstotliwość z postacią o pojedynczej półfali to różnice w maksymalnych przyspieszeniach nie są skokowe. W takim przypadku istotną rolę wydaje się mieć również typ decydującego modelu pojazdu HSLM-A (Rys. \ref{fig:opti_res_2_freqs_niels_300_g}). Zwiększenie częstotliwości dla postaci o pojedynczej półfali powyżej pewnej granicy wymusza zastosowanie dzielnika $k=2$ dla niektórych, cięższych pojazdów. Obciążenie osi pojazdu HSLM-A1 i A6 (pola czerwone i turkusowe) są jednymi z najniższych wśród wszystkich modeli HSLM-A.
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_f}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_160/netw_160_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_netw_160_h}}
...
\begin{enumerate}
	...
	\item Wszystkie rozwiązania mieszczą się powyżej granicy $f_{160,1}^{max}$ dla częstotliwości o obu rozpatrywanych postaciach. Przekłada się to na konieczność zastosowania dzielnika prędkości krytycznej $k>1$ (Rys. \ref{fig:opti_res_2_freqs_netw_160_h}). Osiągnięte minimalne częstotliwości o postaci z podwójną półfalą są większe niż w pozostałych wariantach.
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_VELOCITY_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_f}} 
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_VCR_DIV_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_h}}
...
\begin{figure}[H]
	...
	\subfloat[predkość decydująca]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_VELOCITY_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_f}}
	\captionsetup{justification=centering}
...
\begin{figure}[H]\ContinuedFloat
	...
	\subfloat[dzielnik $k$ przy obliczaniu prędkości rezonansowej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_300/netw_300_FREQ_VCR_DIV_XY.pdf} \label{fig:opti_res_2_freqs_netw_300_h}}

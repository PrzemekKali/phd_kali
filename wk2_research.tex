...
\begin{figure}[H]
	...
	\subfloat[postać drgań decydująca o najbardziej niekorzystnej prędkości krytycznej]{\includegraphics[width=0.5\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_DEC_FREC_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_e}}
	\subfloat[predkość decydująca]{\includegraphics[width=0.47\textwidth,trim=40 20 5 20, clip]{WK2/opti/netw_200/netw_200_FREQ_VELOCITY_XY.pdf}\label{fig:opti_res_2_freqs_netw_200_f}} \hfill
	\captionsetup{justification=centering}

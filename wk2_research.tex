...
\begin{itemize}
	\item możliwość wykorzystania układu w danym wariancie wieszaków i przy danej prędkości maksymalnej, przy spełnieniu kryterium bezpieczeństwa $3.5\,\mathrm{m/s^2}$,
...
\begin{figure}[H]
	...
	\subfloat[]{\includegraphics[trim=20 5 7 5, clip]{WK2/opti/proste_160/proste_160_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{tabular}{@{}lcccc@{}}
	...
	Kwadrat wsp. korelacji zerowej    & $r^2$      & 0.84                 & 0.28               & 0.38                    \\
	Wsp. korelacji stopnia zerowego   & $r$        & -0.92                & -0.53              & -0.61                   \\
	Kwadrat wsp. korelacji cząstkowej & $\rho r^2$ & 0.77                 & 0.02               & 0.09                    \\
	Wsp. korelacji cząstkowej         & $\rho r$   & -0.88                & 0.13               & 0.29                    \\
	Kwadrat wsp. semikorelacji        & $sr^2$     & 0.46                 & 0.00               & 0.01                    \\
	Wsp. semikorelacji                & $sr$       & -0.68                & 0.05               & 0.11                    \\ \bottomrule
\end{tabular}
...
\begin{figure}[H]
	...
	\subfloat[]{\includegraphics[trim=20 5 7 5, clip]{WK2/opti/proste_200/proste_200_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{table}[]
	...
	\begin{tabular}{@{}lcccc@{}}
		\toprule
		& Symbol     & \begin{tabular}[c]{@{}c@{}}Ściąg\\ $h_2 \sim a_{max}$\end{tabular} & \begin{tabular}[c]{@{}c@{}}Łuk\\ $h_1 \sim a_{max}$\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wieszaki\\ $d_1 \sim a_{max}$\end{tabular} \\ \midrule
		Kwadrat wsp. korelacji zerowej    & $r^2$      & 0.80        & 0.29 & 0.19                                                              \\
		Wsp. korelacji stopnia zerowego   & $r$        & -0.89       & -0.54 & -0.43                                                             \\
		Kwadrat wsp. korelacji cząstkowej & $\rho r^2$ & 0.77         & 0.24  & 0.07                                                              \\
		Wsp. korelacji cząstkowej         & $\rho r$   & -0.88       & 0.49 & -0.27                                                             \\
		Kwadrat wsp. semikorelacji        & $sr^2$     & 0.46        & 0.04 & 0.01                                                              \\
		Wsp. semikorelacji                & $sr$       & -0.68       & 0.21 & -0.10                                                             \\ \bottomrule
		\end{tabular}

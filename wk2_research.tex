...
\end{itemize}
które stanowią zmienne projektowe problemu optymalizacji zestawione w wektor $\vect{X}=[h_1,h_2,d_1]$. Zmienne zaznaczono na przekrojach poprzecznych przedstawionych na rysunku \ref{fig:wk2_opti_cs_elements}.
\begin{figure}[hbt!]
	\centering

...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}c|c|c|cccc|llll@{}}
			...
			\toprule
			\multicolumn{1}{l|}{} & \textbf{\begin{tabular}[c]{@{}c@{}}Analiza\\ modalna\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Zakładane\\ tłumienie\end{tabular}} & \multicolumn{4}{c|}{\textbf{Model MES niekalibrowany}}                                      & \multicolumn{4}{c}{\textbf{Badania}}                                                                                                                        \\ \midrule

...
\begin{tabular}{@{}ccccccc@{}}
	\toprule
	\multirow{3}{*}[-5pt]{\begin{tabular}[c]{@{}c@{}}Układ\\ wieszaków\end{tabular}} &
	\multirow{3}{*}[-5pt]{Prędkość} &
	\multirow{3}{*}[-5pt]{\begin{tabular}[c]{@{}c@{}}Minimalny stopień \\ wykorzystania przekroju \\ $a_{max}<3.5\;[m/s^2]$\end{tabular}} &
	...
	&     &                        & Łuk                  & Ściąg                & Wieszaki             &              \\ \cmidrule(lr){4-6}
	&     &                        & $h_1\;\mathrm{[mm]}$ & $h_2\;\mathrm{[mm]}$ & $d_1\;\mathrm{[mm]}$ &              \\ \midrule 

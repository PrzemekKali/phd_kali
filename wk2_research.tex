...
Analizę dynamiczną przeprowadzano w module DYNA środowiska MES SOFiSTiK. Wykorzystano metodę bezpośredniego całkowania równań ruchu Newmarka. Zgodnie z zaleceniami (CYTOWANIE) należy uwzględnić odpowiedź dynamiczną w zakresie częstotliwości do 30Hz. Aby zapewnić poprawne odwzorowanie przyspieszeń i częstotliwości w zadanym zakresie przyjęto krok czasowy równy $\Delta t = 0.005\,s$ (próbkowanie 200 Hz).
Analizę dynamiczną przeprowadzono dla wszystkich dziesięciu modeli obciążeń pociągami uniwersalnymi HSLM-A wg PN-EN 1991.

Prędkości pociągów przyjmowano zgodnie z zaleceniem w zakresie od 40 km/h do maksymalnej prędkości obliczeniowej ($1.2\times\,$nominalna prędkość maksymalna). Nie przyjmowano stałego kroku uwzględnianych prędkości. Wybrano jedynie prędkości które mieszczą się w powyższym zakresie oraz są prędkościami krytycznymi. Prędkości krytyczne obliczano na podstawie wzoru \ref{}. Założono, że odpowiedź obiektu osiąga swoją maksymalną wartość dla prędkości krytycznej i przy zwiększeniu prędkości nie przekracza tej wartości \parencite{J.M.Goicolea-Ruigomez2008}. Potrzebne częstotliwości drgań własnych odczytywano z modelu numerycznego po przeprowadzeniu analizy modalnej. Dla każdego pociągu HSLM-A wyznaczano prędkość na bazie typowego rozstawu osi $d$, odczytanych częstotliwości drgań własnych $\phi_i$ oraz przyjmując wartość $n = 1,2\dots 10$. Jeżeli prędkość rezonansowa dla danego pociągu mieściła się w wymaganym zakresie dodawano ją do obliczanego zestawu. 

Tłumienie uwzględniono jako masowo-sztywnościowe. Współczynniki Rayleigha \ref{} wyznaczano za każdym razem tak, aby liczba tłumienia dla dwóch pierwszych modów była równa $\xi=0.006$. Wartość została przyjęta na podstawie przeprowadzonej identyfikacji realnego obiektu \ref{tab: wk2_ident_mods}. Wybrano wartość najniższą dla modów o dominującym, pionowym kierunku postaci drgań. Wymagane do obliczeń współczynników częstości drgań własnych każdorazowo wyznaczane były w analizie modalnej.
...
\begin{enumerate}
	\item Generacja modelu uproszczonego o wymiarach przekrojów poprzecznych zgodnych ze zmiennymi projektowymi.
	\item Wprowadzenie obciążeń stałych i ruchomych do obliczeń statycznych.
	\item Analiza statyczna, kombinatoryka i obliczenia wytrzymałościowe od obliczeniowych wartości obciążeń statycznych.
	\item Analiza modalna. Wyznaczenie pierwszych pięciu zestawów parametrów modalnych: częstotliwości i postaci drgań własnych.
	\item Wyznaczenie prędkości rezonansowych i współczynników Rayleigha. Wczytanie danych do modelu.
	\item Generacja obciążenia pociągiem HSLM-A. Analiza dynamiczna przejazdu pociągu po obiekcie. Odczytanie przebiegu przyspieszeń w czasie dla trzech punków zlokalizowanych na ściągu w $1/4L$, $1/2L$ i $3/4L$. Punkt wykonywany jest dla wszystkich dziesięciu pociągów HSLM-A i wyznaczonych prędkości rezonansowych.
	\item Przetworzenie sygnałów przyspieszeń: filtrowanie w zakresie do 30 Hz i usunięcie wartości stałej. Wyznaczenie wartości maksymalnej przyspieszeń ze wszystkich przebiegów.
	\item Odczytanie objętości konstrukcji stalowej na podstawie przekrojów poprzecznych łuku, ściągu i wieszaków.
	\item Zestawienie wektora funkcji celu $\vect{F}=[f_s,f_a]$ oraz wektora ograniczeń $\vect{C}=[c_{sa}, c_{sg}, c_{sh}, c_d]$. Przekazanie wyznaczonych rezultatów do algorytmu optymalizacyjnego.
\end{enumerate}

Na rysunku \ref{fig:wk2_dynamic_algorithm} przedstawiono schemat blokowy algorytmu. Ikonami oznaczono w jakim środowisku wykonywane są dane kroki, oraz kierunek przepływu informacji lub współpracę obu środowisk.
\begin{figure}[p]
	\centering
	\includegraphics[height=0.9\textheight]{/WK2/dynamic/algorithm_analiza_dynamiczna.pdf} 
	\captionsetup{justification=centering}
...
Optymalizację konstrukcji przeprowadzono dla dwóch funkcji celu $\vect{F}=[f_s,f_a]$, trzech wariantów rozkładu wieszaków i trzech prędkości maksymalnych. Poniżej zaprezentowano i omówiono wyniki dla każdego z wariantów.


\subsection{Wieszaki Proste - prędkość maksymalna 160 km/h}
\begin{figure}[!htb]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 12 15, clip]{WK2/opti/proste_160/proste_160_0.0.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 12 15, clip]{WK2/opti/proste_160/proste_160_0.3.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 12 15, clip]{WK2/opti/proste_160/proste_160_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/proste_160/proste_160_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_160/proste_160_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_160/proste_160_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami prostymi przy przejeździe z maksymalną prędkością 160 km/h}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0 5 12 15, clip]{WK2/opti/proste_200/proste_200_0.0.pdf}}
	\subfloat[]{\includegraphics[trim=0 5 12 15, clip]{WK2/opti/proste_200/proste_200_0.3.pdf}}
	\subfloat[]{\includegraphics[trim=0 5 12 15, clip]{WK2/opti/proste_200/proste_200_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/proste_200/proste_200_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_200/proste_200_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_200/proste_200_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami prostymi przy przejeździe z maksymalną prędkością 200 km/h}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/proste_300/proste_300_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/proste_300/proste_300_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/proste_300/proste_300_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/proste_300/proste_300_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_300/proste_300_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/proste_300/proste_300_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami prostymi przy przejeździe z maksymalną prędkością 200 km/h}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_160/niels_160_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_160/niels_160_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_160/niels_160_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/niels_160/niels_160_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_160/niels_160_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_160/niels_160_wieszak.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_200/niels_200_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_200/niels_200_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_200/niels_200_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/niels_200/niels_200_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_200/niels_200_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_200/niels_200_wieszak.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_300/niels_300_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_300/niels_300_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/niels_300/niels_300_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/niels_300/niels_300_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_300/niels_300_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/niels_300/niels_300_wieszak.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_160/netw_160_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_160/netw_160_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_160/netw_160_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/netw_160/netw_160_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_160/netw_160_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_160/netw_160_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami typu network przy przejeździe z maksymalną prędkością 160 km/h}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_200/netw_200_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_200/netw_200_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_200/netw_200_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/netw_200/netw_200_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_200/netw_200_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_200/netw_200_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami typu network przy przejeździe z maksymalną prędkością 200 km/h}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_300/netw_300_0.0.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_300/netw_300_0.3.pdf}}
	\subfloat[]{\includegraphics[width=0.33\linewidth,trim=0 5 12 15, clip]{WK2/opti/netw_300/netw_300_0.5.pdf}}
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[]{\includegraphics[trim=0  5 5 0, clip]{WK2/opti/netw_300/netw_300_sciag.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_300/netw_300_luk.pdf}}
	\subfloat[]{\includegraphics[trim=20 5 5 0, clip]{WK2/opti/netw_300/netw_300_wieszak.pdf}}
	\captionsetup{justification=centering}
	\caption{Maksymalne przyspieszenia pomostu i masa przęsła mostu łukowego z wieszakami typu network przy przejeździe z maksymalną prędkością 300 km/h}

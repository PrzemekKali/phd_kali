...
Test numeryczny wykonano na modelu ramy przestrzennej o zewnętrznym schemacie statycznym bliskim belce swobodnie podpartej. Model wykonano w środowisku MES SOFiSTiK z użyciem jednowymiarowych elementów belkowych. Wizualizację oraz schemat statyczny pokazano na rysunku (!!!).
...
\end{itemize}
Na modelu wykonano analizę time-step Newmarka-Wilsona. Znając rozwiązanie dynamicznego problemu własnego dla przedmiotowego modelu zauważono, że pierwszych 5 częstotliwości drgań własnych mieści się w zakresie do 400 Hz. Z tego względu przyjęto krok całkowania jako $\Delta t = 0.001 s$. Zgodnie z kryterium Nyquista pozwoliło to zarejestrować drgania teoretycznie do częstotliwości 500 Hz. Nadpróbkowany sygnał względem najbardziej interesujących pierwszych trzech modów (zawartych do 200Hz) zmniejsza ryzyko i wpływ ewentualnych błędów numerycznych na odpowiedź modów bliskich połowie częstotliwości próbkowania. Błędy te są naturalną konsekwencja stosowania algorytmu bezpośredniego całkowania bez tłumienia numerycznego. W każdym kroku struktura była obciążana losowym przypadkiem obliczeniowym z bazy 5000 wcześniej wygenerowanych. Chcąc sprawdzić charakter obciążenia wykonano analizę FFT na sygnale złożonym z wartości obciążenia jednego z węzłów w czasie. Widmo częstotliwościowe przedstawiono na rysunku (!!!). Całkowity czas analizy przyjęto jako 25s (25000 kroków czasowych).
\begin{figure}[h]
	\centering
	\subfloat[Węzeł 7, kierunek Y]{\includegraphics{/test_blue/input_load/fig_20_59_12_0.555.pdf}}%
	\subfloat[Węzeł 7, kierunek Z]{\includegraphics{/test_blue/input_load/fig_20_59_13_0.655.pdf}}\\
	\subfloat[Węzeł 11, kierunek Y]{\includegraphics{/test_blue/input_load/fig_20_59_13_0.414.pdf}}%
	\subfloat[Węzeł 11, kierunek Z]{\includegraphics{/test_blue/input_load/fig_20_59_13_0.079.pdf}}%
	\captionsetup{justification=centering}
...
Dla obliczonego modelu odczytano przebieg przyspieszeń w dziewięciu węzłach pośrednich, na kierunku pionowym i poprzecznym. Do programu wprowadzono stworzone sygnały z informacją o lokalizacji punktów odczytu. Z sygnałów usunięto składową stałą. Uzyskano odpowiedzi impulsowe jak na rysunku {\ref{fig: cross_corr_blue_beam}}. W dalszej części zastosowano algorytm ERA. Doboru parametrów dokonano przy pomocy diagramu stabilizacyjnego.

\begin{figure}[h]
	\centering
	\subfloat[Diagram niefiltrowany]{\includegraphics[width=\linewidth]{/test_blue/stab_diag/fig_stab_diagram_nonfiltr_time_22_31_32.pdf}}\\
	\subfloat[Diagram filtrowany]{\includegraphics[width=\linewidth]{/test_blue/stab_diag/fig_stab_diagram_filtr_time_22_33_13.pdf}}%
	\captionsetup{justification=centering}
...
\begin{figure}[h]
	\centering
	\subfloat[Węzeł 7, kierunek Y]{\includegraphics{/test_blue/ccf/fig_CCF_CSD_00003_19_59_23.pdf}}%
	\subfloat[Węzeł 7, kierunek Z]{\includegraphics{/test_blue/ccf/fig_CCF_CSD_00004_19_59_32.pdf}}\\
	\subfloat[Węzeł 11, kierunek Y]{\includegraphics{/test_blue/ccf/fig_CCF_CSD_00007_19_59_25.pdf}}%
	\subfloat[Węzeł 11, kierunek Z]{\includegraphics{/test_blue/ccf/fig_CCF_CSD_00008_19_59_34.pdf}}%
	\captionsetup{justification=centering}
	...
	\begin{tabular}[c]{c}
		\subfloat[Mod 1, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod1}%
			\begin{tabular}[b]{c c c}
				\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_0_time_00_17_57.pdf}%
				\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_0_time_00_19_14.pdf}%
				\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_0_time_22_53_14.pdf}%
			\end{tabular}}\\
		
		\subfloat[Mod 2, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod2}%
			\begin{tabular}[b]{c c c}
				\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_2_time_00_19_31.pdf}%
				\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_2_time_00_19_46.pdf}%
				\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_2_time_22_53_25.pdf}%
		\end{tabular}}\\
		\subfloat[Mod 3, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod3}%
		\begin{tabular}[b]{c c c}
			\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_4_time_00_20_17.pdf}%
			\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_4_time_00_20_25.pdf}%
			\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_4_time_22_53_36.pdf}%
	\end{tabular}}\\
		\subfloat[Mod 4, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod4}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_6_time_00_20_53.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_6_time_00_21_00.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_6_time_22_53_55.pdf}%
\end{tabular}}\\
	\end{tabular}
...
\begin{figure}[h]\ContinuedFloat
	...
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_8_time_00_21_13.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_8_time_00_21_23.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_8_time_22_54_06.pdf}%
\end{tabular}}\\
		\subfloat[Mod 6, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod6}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_10_time_00_21_41.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_10_time_00_21_53.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_10_time_22_54_15.pdf}%
\end{tabular}}\\
		\subfloat[Mod 7, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod7}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_12_time_00_22_11.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_12_time_00_22_18.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_12_time_22_54_40.pdf}%
\end{tabular}}\\
		\subfloat[Mod 8, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod8}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_14_time_00_22_33.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_14_time_00_22_39.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_14_time_22_54_49.pdf}%
\end{tabular}}\\
	\end{tabular}
...
\begin{figure}[h]\ContinuedFloat
	\centering
	\begin{tabular}[c]{c}
		\subfloat[Mod 9, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod9}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_16_time_00_22_57.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_16_time_00_23_07.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_16_time_22_55_10.pdf}%
\end{tabular}}\\
		\subfloat[Mod 10, $f_1=1.1111 \text{Hz}$]{\label{fig: test_blue_mod10}%
	\begin{tabular}[b]{c c c}
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_18_time_00_23_23.pdf}%
		\includegraphics[width=0.35\linewidth]{/test_blue/blue_modes/fig_mod_18_time_00_23_28.pdf}%
		\includegraphics[width=0.3\linewidth]{/test_blue/polar/fig_polar_mod_18_time_22_55_21.pdf}%
\end{tabular}}\\

	\end{tabular}
	\caption{Full caption cont.}
	\label{fig: test_blue_mods}
\end{figure}

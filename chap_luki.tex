...
\begin{figure}[p]
	...
	%
	\subfloat[Wiadukt w ciągu Obwodnicy Południowej - Gdańsk Południe (arch. własne)]{\includegraphics[width=0.48\linewidth]{/mosty_wstep/photos/kolejowy_POG_1_1.jpg} \label{fig:arch_deck_bridges_g}} \;
	%
